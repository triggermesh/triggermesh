...
const (
	sourceKind     = "AzureServiceBusSource"
	sourceResource = "azureservicebussource"
)
 ...
 * Instantiate the AzureServiceBusSource
 * Send an event to the AzureServiceBusSource and look for a response
*/

var _ = Describe("Azure ServiceBus", func() {
	...
	Context("a source watches an servicebus topic", func() {
		...
		Context("the subscription is managed by the source", func() {
			...
			BeforeEach(func() {
				By("creating a AzureServiceBusSource object", func() {
...
// createSource creates an AzureServiceBusSource object initialized with the test parameters
...
// createTopicID will create the topicID path used by the k8s azureservicebussource
...
// createQueueID will create the queueID path used by the k8s azureservicebussource
