...
import (
	...
	e2edynamodb "github.com/triggermesh/triggermesh/test/e2e/framework/aws/dynamodb"
...
const (
	sourceKind     = "AWSDynamoDBSource"
	sourceResource = "awsdynamodbsources"
)

var _ = Describe("AWS DynamoDB source", func() {
	f := framework.New("awsdynamodbsource")
	...
	Context("a source watches an existing table", func() {
		var dc dynamodbiface.DynamoDBAPI
	...
	When("a client creates a source object with invalid specs", func() {
		...
		BeforeEach(func() {
			tableARN = "arn:aws:dynamodb:us-west-2:123456789012:table/fake-table"
		...
		Specify("the API server rejects the creation of that object", func() {
			...
			By("setting an invalid ARN", func() {
				invalidARN := "arn:aws:dynamodb:invalid::"
...
// createSource creates an AWSDynamoDBSource object initialized with the given options.
