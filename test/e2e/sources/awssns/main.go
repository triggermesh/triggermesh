...
import (
	...
	e2esns "github.com/triggermesh/triggermesh/test/e2e/framework/aws/sns"
...
var _ = Describe("AWS SNS source", func() {
	...
	// Requires a public HTTP endpoint, which our CI environment does not expose.
	XContext("a source watches an existing topic", func() {
