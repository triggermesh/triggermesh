...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureactivitylogssource"
...
func NewController(
	...
	typ := (*v1alpha1.AzureActivityLogsSource)(nil)
	...
	r := &Reconciler{
		cg:         insights.NewClientGetter(k8sclient.Get(ctx).CoreV1().Secrets),
		adapterCfg: adapterCfg,
	}
	impl := reconcilerv1alpha1.NewImpl(ctx, r)

	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AzureActivityLogsSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureActivityLogsSources,
	)
