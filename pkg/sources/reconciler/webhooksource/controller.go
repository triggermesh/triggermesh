...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/webhooksource"
...
func NewController(
	...
	r.base = common.NewGenericServiceReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.WebhookSource] {
			return informer.Lister().WebhookSources(namespace)
		},
	)
