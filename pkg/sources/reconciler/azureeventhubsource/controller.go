...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureeventhubsource"
...
func NewController(
	...
	typ := (*v1alpha1.AzureEventHubSource)(nil)
	...
	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AzureEventHubSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureEventHubSources,
	)
