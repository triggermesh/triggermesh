...
func NewController(
	...
	typ := (*v1alpha1.AzureBlobStorageSource)(nil)
	...
	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AzureBlobStorageSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureBlobStorageSources,
	)
