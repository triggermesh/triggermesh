...
type Reconciler struct {
	base       common.GenericDeploymentReconciler[*v1alpha1.AzureServiceBusQueueSource, listersv1alpha1.AzureServiceBusQueueSourceNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, src *v1alpha1.AzureServiceBusQueueSource) reconciler.Event {
