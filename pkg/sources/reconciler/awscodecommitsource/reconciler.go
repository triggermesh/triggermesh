...
type Reconciler struct {
	base       common.GenericDeploymentReconciler[*v1alpha1.AWSCodeCommitSource, listersv1alpha1.AWSCodeCommitSourceNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, src *v1alpha1.AWSCodeCommitSource) reconciler.Event {
