...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/twiliosource"
...
func NewController(
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.TwilioSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().TwilioSources,
	)
