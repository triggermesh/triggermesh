...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudauditlogssource"
...
func NewController(
	...
	typ := (*v1alpha1.GoogleCloudAuditLogsSource)(nil)
	...
	r := &Reconciler{
		cg:         auditlogs.NewClientGetter(k8sclient.Get(ctx).CoreV1().Secrets),
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.GoogleCloudAuditLogsSource] {
			return informer.Lister().GoogleCloudAuditLogsSources(namespace)
		},
	)
