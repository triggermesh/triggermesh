...
type Reconciler struct {
	...
	cg auditlogs.ClientGetter

	// Pub/Sub adapter
	base       common.GenericDeploymentReconciler[*v1alpha1.GoogleCloudAuditLogsSource, listersv1alpha1.GoogleCloudAuditLogsSourceNamespaceLister]
