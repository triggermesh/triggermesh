...
func newReconciledSource(opts ...sourceOption) (*v1alpha1.AzureServiceBusTopicSource, error) {
	src := newEventSource()
...
func mustNewReconciledSource(t *testing.T) func(...sourceOption) *v1alpha1.AzureServiceBusTopicSource {
	return func(opts ...sourceOption) *v1alpha1.AzureServiceBusTopicSource {
