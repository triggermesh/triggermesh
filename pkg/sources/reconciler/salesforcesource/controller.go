...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/salesforcesource"
...
func NewController(
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.SalesforceSource] {
			return informer.Lister().SalesforceSources(namespace)
		},
	)
