...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awsdynamodbsource"
...
func NewController(
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.AWSDynamoDBSource] {
			return informer.Lister().AWSDynamoDBSources(namespace)
		},
	)
