...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awskinesissource"
	reconcilerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/reconciler/sources/v1alpha1/awskinesissource"
...
func NewController(
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.AWSKinesisSource] {
			return informer.Lister().AWSKinesisSources(namespace)
		},
	)
