...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awseventbridgesource"
	...
	"github.com/triggermesh/triggermesh/pkg/sources/client/eventbridge"
)

// the resync period ensures we regularly re-check the state of EventBridge event rules.
...
func NewController(
	...
	typ := (*v1alpha1.AWSEventBridgeSource)(nil)
	...
	r := &Reconciler{
		ebCg:       eventbridge.NewClientGetter(k8sclient.Get(ctx).CoreV1().Secrets),
		adapterCfg: adapterCfg,
	}
	impl := reconcilerv1alpha1.NewImpl(ctx, r)

	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AWSEventBridgeSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AWSEventBridgeSources,
	)
