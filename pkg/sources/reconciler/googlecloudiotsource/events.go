...
const (
	// ReasonSubscribed indicates that a source subscribed to messages
	// from a Cloud IoT Registry.
	ReasonSubscribed = "Subscribed"
	// ReasonUnsubscribed indicates that a source unsubscribed from messages
	// from a Cloud IoT Registry.
	ReasonUnsubscribed = "Unsubscribed"
	// ReasonFailedSubscribe indicates a failure while synchronizing the
	// configuration of a Cloud IoT Registry, or the Pub/Sub
