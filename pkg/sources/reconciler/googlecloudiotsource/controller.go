...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudiotsource"
...
func NewController(
	...
	typ := (*v1alpha1.GoogleCloudIoTSource)(nil)
	...
	r := &Reconciler{
		cg:         iot.NewClientGetter(k8sclient.Get(ctx).CoreV1().Secrets),
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.GoogleCloudIoTSource] {
			return informer.Lister().GoogleCloudIoTSources(namespace)
		},
	)
