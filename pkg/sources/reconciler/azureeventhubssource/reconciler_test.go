...
import (
	...
	reconcilerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/reconciler/sources/v1alpha1/azureeventhubssource"
...
func reconcilerCtor(cfg *adapterConfig) Ctor {
	return func(t *testing.T, ctx context.Context, _ *rt.TableRow, ls *Listers) controller.Reconciler {
		...
		r.base = NewTestDeploymentReconciler[*v1alpha1.AzureEventHubsSource](ctx, ls,
			ls.GetAzureEventHubsSourceLister().AzureEventHubsSources,
		)

		return reconcilerv1alpha1.NewReconciler(ctx, logging.FromContext(ctx),
			fakeinjectionclient.Get(ctx), ls.GetAzureEventHubsSourceLister(),
			controller.GetEventRecorder(ctx), r)
	}
}

// newEventSource returns a populated source object.
func newEventSource() *v1alpha1.AzureEventHubsSource {
	src := &v1alpha1.AzureEventHubsSource{
		Spec: v1alpha1.AzureEventHubsSourceSpec{
