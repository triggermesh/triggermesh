...
func newReconciledSource(opts ...sourceOption) (*v1alpha1.AzureEventGridSource, error) {
	src := newEventSource()
...
func mustNewReconciledSource(t *testing.T) func(...sourceOption) *v1alpha1.AzureEventGridSource {
	return func(opts ...sourceOption) *v1alpha1.AzureEventGridSource {
