...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureeventgridsource"
...
func NewController(
	...
	typ := (*v1alpha1.AzureEventGridSource)(nil)
	...
	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AzureEventGridSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureEventGridSources,
	)
