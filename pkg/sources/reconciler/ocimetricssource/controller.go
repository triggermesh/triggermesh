...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/ocimetricssource"
...
func NewController(
	...
	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.OCIMetricsSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().OCIMetricsSources,
	)
