...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awssqssource"
...
func NewController(
	...
	r.base = common.NewGenericDeploymentReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.AWSSQSSource] {
			return informer.Lister().AWSSQSSources(namespace)
		},
	)
