...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awscloudwatchsource"
...
func NewController(
	...
	typ := (*v1alpha1.AWSCloudWatchSource)(nil)
	...
	r.base = common.NewGenericDeploymentReconciler[*v1alpha1.AWSCloudWatchSource](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AWSCloudWatchSources,
	)
