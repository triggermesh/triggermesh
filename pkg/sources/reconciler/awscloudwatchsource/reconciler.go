...
type Reconciler struct {
	base       common.GenericDeploymentReconciler[*v1alpha1.AWSCloudWatchSource, listersv1alpha1.AWSCloudWatchSourceNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, src *v1alpha1.AWSCloudWatchSource) reconciler.Event {
