...
// newComponent returns a test DataWeaveTransformation object with pre-filled attributes.
func newComponent() *v1alpha1.DataWeaveTransformation {
	o := &v1alpha1.DataWeaveTransformation{
...
// Deployed: True
func newComponentDeployed() *v1alpha1.DataWeaveTransformation {
	o := newComponent()
...
// Deployed: False
func newComponentNotDeployed() *v1alpha1.DataWeaveTransformation {
	o := newComponent()
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*kmeta.NewControllerRef(NewOwnerRefable(
					tName,
					(&v1alpha1.DataWeaveTransformation{}).GetGroupVersionKind(),
					tUID,
				)),
			},
		},
								...
								Env: []corev1.EnvVar{
									{
										...
										Value: tIncomingDataType,
									}, {
										Name:  envOutputContentType,
										Value: tOutputDataType,
									}, {
...
func newAdapterServiceReady() *servingv1.Service {
	...
	svc.Status.SetConditions(apis.Conditions{{
		Type:   v1alpha1.DataWeaveTransformationConditionReady,
