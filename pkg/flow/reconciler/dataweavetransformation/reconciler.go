...
func (r *reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.DataWeaveTransformation) pkgreconciler.Event {
	var url *apis.URL
	if o.Spec.Sink != nil {
		var err error
	...
	if err != nil {
		o.Status.MarkNotDeployed(v1alpha1.DataWeaveTransformationReasonWrongSpec, "Cannot create adapter from spec")
...
func (r *reconciler) resolveDestination(ctx context.Context, s *v1alpha1.DataWeaveTransformation) (*apis.URL, error) {
