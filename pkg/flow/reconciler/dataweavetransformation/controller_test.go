...
import (
	...
	_ "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/flow/v1alpha1/dataweavetransformation/fake"
...
func TestNewController(t *testing.T) {
	t.Run("No failure", func(t *testing.T) {
		TestControllerConstructor(t, NewController, WithInformerNumber(2))
	})
