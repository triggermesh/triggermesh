...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.XSLTTransformation, listersv1alpha1.XSLTTransformationNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.XSLTTransformation) reconciler.Event {
