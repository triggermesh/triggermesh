...
func NewController(
	...
	typ := (*v1alpha1.XSLTTransformation)(nil)
	...
	r.base = common.NewGenericServiceReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.XSLTTransformation] {
			return informer.Lister().XSLTTransformations(namespace)
		},
	)
