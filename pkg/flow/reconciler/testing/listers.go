...
import (
	...
	faketmclient "github.com/triggermesh/triggermesh/pkg/client/generated/clientset/internalclientset/fake"
	flowlisters "github.com/triggermesh/triggermesh/pkg/client/generated/listers/flow/v1alpha1"
)

var clientSetSchemes = []func(*runtime.Scheme) error{
	faketmclient.AddToScheme,
...
// GetXsltTransformObjects returns objects from the API.
func (l *Listers) GetXsltTransformObjects() []runtime.Object {
	return l.sorter.ObjectsForSchemeFunc(faketmclient.AddToScheme)
}

// GetKubeObjects returns objects from the TriggerMesh API.
...
// GetXsltTransformLister returns a Lister for that object type.
