...
func (f *splunkTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&targetsv1alpha1.SplunkTarget{}, f.defaultInformer)
}

func (f *splunkTargetInformer) Lister() v1alpha1.SplunkTargetLister {
	return v1alpha1.NewSplunkTargetLister(f.Informer().GetIndexer())
}
