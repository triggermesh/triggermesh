...
func (f *kafkaTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&targetsv1alpha1.KafkaTarget{}, f.defaultInformer)
}

func (f *kafkaTargetInformer) Lister() v1alpha1.KafkaTargetLister {
	return v1alpha1.NewKafkaTargetLister(f.Informer().GetIndexer())
}
