...
import (
	...
	xmltojsontransformation "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/flow/v1alpha1/xmltojsontransformation"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "xmltojsontransformation-controller"
	defaultFinalizerName       = "xmltojsontransformations.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	xmltojsontransformationInformer := xmltojsontransformation.Get(ctx)

	lister := xmltojsontransformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.XMLToJSONTransformation"),
	)
