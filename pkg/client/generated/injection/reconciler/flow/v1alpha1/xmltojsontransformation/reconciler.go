...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.XMLToJSONTransformation, desiredFinalizers sets.String) (*v1alpha1.XMLToJSONTransformation, error) {
	// Don't modify the informers copy.
