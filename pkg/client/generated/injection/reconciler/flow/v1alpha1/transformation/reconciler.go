...
type reconcilerImpl struct {
	...
	Lister flowv1alpha1.TransformationLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client internalclientset.Interface, lister flowv1alpha1.TransformationLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Transformation, desiredFinalizers sets.String) (*v1alpha1.Transformation, error) {
	// Don't modify the informers copy.
