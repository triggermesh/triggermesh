...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Synchronizer, desiredFinalizers sets.String) (*v1alpha1.Synchronizer, error) {
	// Don't modify the informers copy.
