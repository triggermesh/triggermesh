...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.JQTransformation, desiredFinalizers sets.String) (*v1alpha1.JQTransformation, error) {
	// Don't modify the informers copy.
