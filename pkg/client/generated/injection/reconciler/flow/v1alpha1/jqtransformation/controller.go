...
import (
	...
	jqtransformation "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/flow/v1alpha1/jqtransformation"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "jqtransformation-controller"
	defaultFinalizerName       = "jqtransformations.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	jqtransformationInformer := jqtransformation.Get(ctx)

	lister := jqtransformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.JQTransformation"),
	)
