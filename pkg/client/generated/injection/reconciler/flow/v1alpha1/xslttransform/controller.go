...
const (
	defaultControllerAgentName = "xslttransform-controller"
	defaultFinalizerName       = "xslttransforms.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	xslttransformInformer := xslttransform.Get(ctx)

	lister := xslttransformInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.XSLTTransform"),
	)
