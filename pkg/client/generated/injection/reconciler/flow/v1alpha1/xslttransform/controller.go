...
const (
	defaultControllerAgentName = "xslttransformation-controller"
	defaultFinalizerName       = "xslttransformations.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	xslttransformationInformer := xslttransformation.Get(ctx)

	lister := xslttransformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.XSLTTransformation"),
	)
