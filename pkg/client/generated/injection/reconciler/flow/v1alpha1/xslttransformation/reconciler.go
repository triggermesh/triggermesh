...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.XSLTTransformation, desiredFinalizers sets.String) (*v1alpha1.XSLTTransformation, error) {
	// Don't modify the informers copy.
