...
import (
	...
	dataweavetransformation "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/flow/v1alpha1/dataweavetransformation"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "dataweavetransformation-controller"
	defaultFinalizerName       = "dataweavetransformations.flow.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	dataweavetransformationInformer := dataweavetransformation.Get(ctx)

	lister := dataweavetransformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.triggermesh.io.DataWeaveTransformation"),
	)
