...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.DataWeaveTransformation, desiredFinalizers sets.String) (*v1alpha1.DataWeaveTransformation, error) {
	// Don't modify the informers copy.
