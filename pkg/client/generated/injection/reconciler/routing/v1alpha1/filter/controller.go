...
import (
	...
	filter "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/routing/v1alpha1/filter"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "filter-controller"
	defaultFinalizerName       = "filters.routing.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	filterInformer := filter.Get(ctx)

	lister := filterInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "routing.triggermesh.io.Filter"),
	)
