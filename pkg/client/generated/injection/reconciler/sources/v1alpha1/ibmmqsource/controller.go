...
import (
	...
	ibmmqsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/ibmmqsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "ibmmqsource-controller"
	defaultFinalizerName       = "ibmmqsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	ibmmqsourceInformer := ibmmqsource.Get(ctx)

	lister := ibmmqsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.IBMMQSource"),
	)
