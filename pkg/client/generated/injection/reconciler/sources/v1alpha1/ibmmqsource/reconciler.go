...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.IBMMQSource, desiredFinalizers sets.String) (*v1alpha1.IBMMQSource, error) {
	// Don't modify the informers copy.
