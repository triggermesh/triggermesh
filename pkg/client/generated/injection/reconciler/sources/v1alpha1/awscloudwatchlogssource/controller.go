...
import (
	...
	awscloudwatchlogssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awscloudwatchlogssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awscloudwatchlogssource-controller"
	defaultFinalizerName       = "awscloudwatchlogssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscloudwatchlogssourceInformer := awscloudwatchlogssource.Get(ctx)

	lister := awscloudwatchlogssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSCloudWatchLogsSource"),
	)
