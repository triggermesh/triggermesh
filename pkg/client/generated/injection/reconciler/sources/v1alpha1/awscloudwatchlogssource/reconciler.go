...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSCloudWatchLogsSource, desiredFinalizers sets.String) (*v1alpha1.AWSCloudWatchLogsSource, error) {
	// Don't modify the informers copy.
