...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.HTTPPollerSource, desiredFinalizers sets.String) (*v1alpha1.HTTPPollerSource, error) {
	// Don't modify the informers copy.
