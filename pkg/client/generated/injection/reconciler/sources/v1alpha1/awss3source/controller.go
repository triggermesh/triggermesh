...
import (
	...
	awss3source "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awss3source"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awss3source-controller"
	defaultFinalizerName       = "awss3sources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awss3sourceInformer := awss3source.Get(ctx)

	lister := awss3sourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSS3Source"),
	)
