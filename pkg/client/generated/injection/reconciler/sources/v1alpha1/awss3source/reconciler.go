...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSS3Source, desiredFinalizers sets.String) (*v1alpha1.AWSS3Source, error) {
	// Don't modify the informers copy.
