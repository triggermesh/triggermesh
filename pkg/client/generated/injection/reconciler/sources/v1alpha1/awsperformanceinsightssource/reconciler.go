...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSPerformanceInsightsSource, desiredFinalizers sets.String) (*v1alpha1.AWSPerformanceInsightsSource, error) {
	// Don't modify the informers copy.
