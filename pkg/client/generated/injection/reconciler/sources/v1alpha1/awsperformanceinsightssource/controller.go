...
import (
	...
	internalclientsetscheme "github.com/triggermesh/triggermesh/pkg/client/generated/clientset/internalclientset/scheme"
	client "github.com/triggermesh/triggermesh/pkg/client/generated/injection/client"
	awsperformanceinsightssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awsperformanceinsightssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awsperformanceinsightssource-controller"
	defaultFinalizerName       = "awsperformanceinsightssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awsperformanceinsightssourceInformer := awsperformanceinsightssource.Get(ctx)

	lister := awsperformanceinsightssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSPerformanceInsightsSource"),
	)
