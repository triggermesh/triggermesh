...
import (
	...
	ocimetricssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/ocimetricssource"
	zap "go.uber.org/zap"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.OCIMetricsSource"),
	)
