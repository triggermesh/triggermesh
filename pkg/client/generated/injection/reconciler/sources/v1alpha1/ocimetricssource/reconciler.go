...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.OCIMetricsSource, desiredFinalizers sets.String) (*v1alpha1.OCIMetricsSource, error) {
	// Don't modify the informers copy.
