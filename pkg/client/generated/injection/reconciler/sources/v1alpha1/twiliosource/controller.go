...
import (
	...
	twiliosource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/twiliosource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "twiliosource-controller"
	defaultFinalizerName       = "twiliosources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	twiliosourceInformer := twiliosource.Get(ctx)

	lister := twiliosourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.TwilioSource"),
	)
