...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ZendeskSource, desiredFinalizers sets.String) (*v1alpha1.ZendeskSource, error) {
	// Don't modify the informers copy.
