...
import (
	...
	azureeventhubssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureeventhubssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureeventhubssource-controller"
	defaultFinalizerName       = "azureeventhubssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureeventhubssourceInformer := azureeventhubssource.Get(ctx)

	lister := azureeventhubssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureEventHubsSource"),
	)
