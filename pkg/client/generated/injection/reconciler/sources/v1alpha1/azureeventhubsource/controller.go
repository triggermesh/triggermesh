...
import (
	...
	azureeventhubsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureeventhubsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureeventhubsource-controller"
	defaultFinalizerName       = "azureeventhubsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureeventhubsourceInformer := azureeventhubsource.Get(ctx)

	lister := azureeventhubsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureEventHubSource"),
	)
