...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSEventBridgeSource, desiredFinalizers sets.String) (*v1alpha1.AWSEventBridgeSource, error) {
	// Don't modify the informers copy.
