...
import (
	...
	awseventbridgesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awseventbridgesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awseventbridgesource-controller"
	defaultFinalizerName       = "awseventbridgesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awseventbridgesourceInformer := awseventbridgesource.Get(ctx)

	lister := awseventbridgesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSEventBridgeSource"),
	)
