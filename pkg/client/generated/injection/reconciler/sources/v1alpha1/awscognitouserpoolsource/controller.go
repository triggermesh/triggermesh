...
import (
	...
	awscognitouserpoolsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awscognitouserpoolsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awscognitouserpoolsource-controller"
	defaultFinalizerName       = "awscognitouserpoolsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscognitouserpoolsourceInformer := awscognitouserpoolsource.Get(ctx)

	lister := awscognitouserpoolsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSCognitoUserPoolSource"),
	)
