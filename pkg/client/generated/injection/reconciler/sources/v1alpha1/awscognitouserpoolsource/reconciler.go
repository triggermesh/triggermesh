...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSCognitoUserPoolSource, desiredFinalizers sets.String) (*v1alpha1.AWSCognitoUserPoolSource, error) {
	// Don't modify the informers copy.
