...
import (
	...
	azureservicebustopicsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureservicebustopicsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureservicebustopicsource-controller"
	defaultFinalizerName       = "azureservicebustopicsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureservicebustopicsourceInformer := azureservicebustopicsource.Get(ctx)

	lister := azureservicebustopicsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureServiceBusTopicSource"),
	)
