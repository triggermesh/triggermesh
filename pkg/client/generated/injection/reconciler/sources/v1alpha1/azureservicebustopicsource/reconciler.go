...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureServiceBusTopicSource, desiredFinalizers sets.String) (*v1alpha1.AzureServiceBusTopicSource, error) {
	// Don't modify the informers copy.
