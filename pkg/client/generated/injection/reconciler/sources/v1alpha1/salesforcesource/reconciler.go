...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SalesforceSource, desiredFinalizers sets.String) (*v1alpha1.SalesforceSource, error) {
	// Don't modify the informers copy.
