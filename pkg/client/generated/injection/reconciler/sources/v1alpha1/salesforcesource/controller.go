...
import (
	...
	salesforcesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/salesforcesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "salesforcesource-controller"
	defaultFinalizerName       = "salesforcesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	salesforcesourceInformer := salesforcesource.Get(ctx)

	lister := salesforcesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.SalesforceSource"),
	)
