...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureBlobStorageSource, desiredFinalizers sets.String) (*v1alpha1.AzureBlobStorageSource, error) {
	// Don't modify the informers copy.
