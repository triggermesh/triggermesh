...
import (
	...
	azureblobstoragesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureblobstoragesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureblobstoragesource-controller"
	defaultFinalizerName       = "azureblobstoragesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureblobstoragesourceInformer := azureblobstoragesource.Get(ctx)

	lister := azureblobstoragesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureBlobStorageSource"),
	)
