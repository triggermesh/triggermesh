...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudAuditLogsSource, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudAuditLogsSource, error) {
	// Don't modify the informers copy.
