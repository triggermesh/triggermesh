...
import (
	...
	googlecloudauditlogssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudauditlogssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudauditlogssource-controller"
	defaultFinalizerName       = "googlecloudauditlogssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudauditlogssourceInformer := googlecloudauditlogssource.Get(ctx)

	lister := googlecloudauditlogssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudAuditLogsSource"),
	)
