...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureEventGridSource, desiredFinalizers sets.String) (*v1alpha1.AzureEventGridSource, error) {
	// Don't modify the informers copy.
