...
import (
	...
	azureeventgridsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureeventgridsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureeventgridsource-controller"
	defaultFinalizerName       = "azureeventgridsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureeventgridsourceInformer := azureeventgridsource.Get(ctx)

	lister := azureeventgridsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureEventGridSource"),
	)
