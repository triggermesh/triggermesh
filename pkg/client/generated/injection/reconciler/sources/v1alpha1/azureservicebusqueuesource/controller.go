...
import (
	...
	azureservicebusqueuesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureservicebusqueuesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureservicebusqueuesource-controller"
	defaultFinalizerName       = "azureservicebusqueuesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureservicebusqueuesourceInformer := azureservicebusqueuesource.Get(ctx)

	lister := azureservicebusqueuesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureServiceBusQueueSource"),
	)
