...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureServiceBusQueueSource, desiredFinalizers sets.String) (*v1alpha1.AzureServiceBusQueueSource, error) {
	// Don't modify the informers copy.
