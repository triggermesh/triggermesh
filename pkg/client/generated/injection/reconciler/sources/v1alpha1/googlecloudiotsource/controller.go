...
import (
	...
	googlecloudiotsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudiotsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudiotsource-controller"
	defaultFinalizerName       = "googlecloudiotsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudiotsourceInformer := googlecloudiotsource.Get(ctx)

	lister := googlecloudiotsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudIoTSource"),
	)
