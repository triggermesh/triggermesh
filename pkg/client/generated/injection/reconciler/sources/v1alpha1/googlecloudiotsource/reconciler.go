...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudIoTSource, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudIoTSource, error) {
	// Don't modify the informers copy.
