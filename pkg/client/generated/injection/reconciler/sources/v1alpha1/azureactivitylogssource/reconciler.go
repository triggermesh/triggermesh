...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureActivityLogsSource, desiredFinalizers sets.String) (*v1alpha1.AzureActivityLogsSource, error) {
	// Don't modify the informers copy.
