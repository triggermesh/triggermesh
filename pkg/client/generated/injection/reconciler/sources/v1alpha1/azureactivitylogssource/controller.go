...
import (
	...
	azureactivitylogssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureactivitylogssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureactivitylogssource-controller"
	defaultFinalizerName       = "azureactivitylogssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureactivitylogssourceInformer := azureactivitylogssource.Get(ctx)

	lister := azureactivitylogssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureActivityLogsSource"),
	)
