...
import (
	...
	googlecloudstoragesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudstoragesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudstoragesource-controller"
	defaultFinalizerName       = "googlecloudstoragesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudstoragesourceInformer := googlecloudstoragesource.Get(ctx)

	lister := googlecloudstoragesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudStorageSource"),
	)
