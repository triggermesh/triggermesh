...
const (
	defaultControllerAgentName = "googlecloudrepositoriessource-controller"
	defaultFinalizerName       = "googlecloudrepositoriessources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudrepositoriessourceInformer := googlecloudrepositoriessource.Get(ctx)

	lister := googlecloudrepositoriessourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudRepositoriesSource"),
	)
