...
import (
	...
	azureservicebussource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureservicebussource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureservicebussource-controller"
	defaultFinalizerName       = "azureservicebussources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureservicebussourceInformer := azureservicebussource.Get(ctx)

	lister := azureservicebussourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureServiceBusSource"),
	)
