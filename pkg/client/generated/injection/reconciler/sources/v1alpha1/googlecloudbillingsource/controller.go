...
import (
	...
	googlecloudbillingsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudbillingsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudbillingsource-controller"
	defaultFinalizerName       = "googlecloudbillingsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudbillingsourceInformer := googlecloudbillingsource.Get(ctx)

	lister := googlecloudbillingsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudBillingSource"),
	)
