...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudBillingSource, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudBillingSource, error) {
	// Don't modify the informers copy.
