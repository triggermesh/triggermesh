...
import (
	...
	cloudeventssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/cloudeventssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "cloudeventssource-controller"
	defaultFinalizerName       = "cloudeventssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	cloudeventssourceInformer := cloudeventssource.Get(ctx)

	lister := cloudeventssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.CloudEventsSource"),
	)
