...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudSourceRepositoriesSource, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudSourceRepositoriesSource, error) {
	// Don't modify the informers copy.
