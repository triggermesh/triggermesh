...
const (
	defaultControllerAgentName = "googlecloudsourcerepositoriessource-controller"
	defaultFinalizerName       = "googlecloudsourcerepositoriessources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudsourcerepositoriessourceInformer := googlecloudsourcerepositoriessource.Get(ctx)

	lister := googlecloudsourcerepositoriessourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudSourceRepositoriesSource"),
	)
