...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSCodeCommitSource, desiredFinalizers sets.String) (*v1alpha1.AWSCodeCommitSource, error) {
	// Don't modify the informers copy.
