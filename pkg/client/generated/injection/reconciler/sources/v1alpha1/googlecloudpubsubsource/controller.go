...
import (
	...
	googlecloudpubsubsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/googlecloudpubsubsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudpubsubsource-controller"
	defaultFinalizerName       = "googlecloudpubsubsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudpubsubsourceInformer := googlecloudpubsubsource.Get(ctx)

	lister := googlecloudpubsubsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.GoogleCloudPubSubSource"),
	)
