...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudPubSubSource, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudPubSubSource, error) {
	// Don't modify the informers copy.
