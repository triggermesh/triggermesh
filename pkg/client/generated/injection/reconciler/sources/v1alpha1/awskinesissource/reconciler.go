...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSKinesisSource, desiredFinalizers sets.String) (*v1alpha1.AWSKinesisSource, error) {
	// Don't modify the informers copy.
