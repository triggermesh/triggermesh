...
import (
	...
	awskinesissource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awskinesissource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awskinesissource-controller"
	defaultFinalizerName       = "awskinesissources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := awskinesissourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSKinesisSource"),
	)
