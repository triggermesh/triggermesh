...
import (
	...
	mongodbsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/mongodbsource"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "mongodbsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.MongoDBSource"),
	)
