...
import (
	...
	awscognitoidentitysource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awscognitoidentitysource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awscognitoidentitysource-controller"
	defaultFinalizerName       = "awscognitoidentitysources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscognitoidentitysourceInformer := awscognitoidentitysource.Get(ctx)

	lister := awscognitoidentitysourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSCognitoIdentitySource"),
	)
