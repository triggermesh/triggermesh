...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSCognitoIdentitySource, desiredFinalizers sets.String) (*v1alpha1.AWSCognitoIdentitySource, error) {
	// Don't modify the informers copy.
