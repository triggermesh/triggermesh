...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSCloudWatchSource, desiredFinalizers sets.String) (*v1alpha1.AWSCloudWatchSource, error) {
	// Don't modify the informers copy.
