...
import (
	...
	awscloudwatchsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awscloudwatchsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awscloudwatchsource-controller"
	defaultFinalizerName       = "awscloudwatchsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscloudwatchsourceInformer := awscloudwatchsource.Get(ctx)

	lister := awscloudwatchsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSCloudWatchSource"),
	)
