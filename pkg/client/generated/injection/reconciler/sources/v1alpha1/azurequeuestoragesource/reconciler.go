...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureQueueStorageSource, desiredFinalizers sets.String) (*v1alpha1.AzureQueueStorageSource, error) {
	// Don't modify the informers copy.
