...
import (
	...
	azurequeuestoragesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azurequeuestoragesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azurequeuestoragesource-controller"
	defaultFinalizerName       = "azurequeuestoragesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azurequeuestoragesourceInformer := azurequeuestoragesource.Get(ctx)

	lister := azurequeuestoragesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureQueueStorageSource"),
	)
