...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSDynamoDBSource, desiredFinalizers sets.String) (*v1alpha1.AWSDynamoDBSource, error) {
	// Don't modify the informers copy.
