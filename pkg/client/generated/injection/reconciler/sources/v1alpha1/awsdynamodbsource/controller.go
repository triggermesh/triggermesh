...
import (
	...
	awsdynamodbsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awsdynamodbsource"
	zap "go.uber.org/zap"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awsdynamodbsourceInformer := awsdynamodbsource.Get(ctx)

	lister := awsdynamodbsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSDynamoDBSource"),
	)
