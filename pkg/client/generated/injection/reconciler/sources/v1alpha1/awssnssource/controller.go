...
import (
	...
	awssnssource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/awssnssource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awssnssource-controller"
	defaultFinalizerName       = "awssnssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awssnssourceInformer := awssnssource.Get(ctx)

	lister := awssnssourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AWSSNSSource"),
	)
