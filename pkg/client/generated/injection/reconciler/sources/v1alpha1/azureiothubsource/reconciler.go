...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureIOTHubSource, desiredFinalizers sets.String) (*v1alpha1.AzureIOTHubSource, error) {
	// Don't modify the informers copy.
