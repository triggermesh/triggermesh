...
import (
	...
	azureiothubsource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/azureiothubsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureiothubsource-controller"
	defaultFinalizerName       = "azureiothubsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureiothubsourceInformer := azureiothubsource.Get(ctx)

	lister := azureiothubsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.AzureIOTHubSource"),
	)
