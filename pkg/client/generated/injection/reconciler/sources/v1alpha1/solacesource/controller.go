...
import (
	...
	solacesource "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/sources/v1alpha1/solacesource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "solacesource-controller"
	defaultFinalizerName       = "solacesources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	solacesourceInformer := solacesource.Get(ctx)

	lister := solacesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.SolaceSource"),
	)
