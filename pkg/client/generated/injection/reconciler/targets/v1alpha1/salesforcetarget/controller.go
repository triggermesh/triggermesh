...
import (
	...
	salesforcetarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/salesforcetarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "salesforcetarget-controller"
	defaultFinalizerName       = "salesforcetargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	salesforcetargetInformer := salesforcetarget.Get(ctx)

	lister := salesforcetargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.SalesforceTarget"),
	)
