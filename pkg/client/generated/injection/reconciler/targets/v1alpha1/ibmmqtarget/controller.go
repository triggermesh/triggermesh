...
import (
	...
	ibmmqtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/ibmmqtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "ibmmqtarget-controller"
	defaultFinalizerName       = "ibmmqtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	ibmmqtargetInformer := ibmmqtarget.Get(ctx)

	lister := ibmmqtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.IBMMQTarget"),
	)
