...
import (
	...
	alibabaosstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/alibabaosstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "alibabaosstarget-controller"
	defaultFinalizerName       = "alibabaosstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	alibabaosstargetInformer := alibabaosstarget.Get(ctx)

	lister := alibabaosstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AlibabaOSSTarget"),
	)
