...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AlibabaOSSTarget, desiredFinalizers sets.String) (*v1alpha1.AlibabaOSSTarget, error) {
	// Don't modify the informers copy.
