...
import (
	...
	googlesheettarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/googlesheettarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlesheettarget-controller"
	defaultFinalizerName       = "googlesheettargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlesheettargetInformer := googlesheettarget.Get(ctx)

	lister := googlesheettargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.GoogleSheetTarget"),
	)
