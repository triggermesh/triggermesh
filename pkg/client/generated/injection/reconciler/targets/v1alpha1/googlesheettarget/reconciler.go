...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleSheetTarget, desiredFinalizers sets.String) (*v1alpha1.GoogleSheetTarget, error) {
	// Don't modify the informers copy.
