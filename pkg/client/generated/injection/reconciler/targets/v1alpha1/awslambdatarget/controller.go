...
import (
	...
	awslambdatarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awslambdatarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awslambdatarget-controller"
	defaultFinalizerName       = "awslambdatargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awslambdatargetInformer := awslambdatarget.Get(ctx)

	lister := awslambdatargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSLambdaTarget"),
	)
