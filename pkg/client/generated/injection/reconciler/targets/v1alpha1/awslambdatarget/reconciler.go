...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSLambdaTarget, desiredFinalizers sets.String) (*v1alpha1.AWSLambdaTarget, error) {
	// Don't modify the informers copy.
