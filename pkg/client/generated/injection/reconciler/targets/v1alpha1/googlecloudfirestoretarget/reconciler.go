...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudFirestoreTarget, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudFirestoreTarget, error) {
	// Don't modify the informers copy.
