...
import (
	...
	googlecloudfirestoretarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/googlecloudfirestoretarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudfirestoretarget-controller"
	defaultFinalizerName       = "googlecloudfirestoretargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudfirestoretargetInformer := googlecloudfirestoretarget.Get(ctx)

	lister := googlecloudfirestoretargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.GoogleCloudFirestoreTarget"),
	)
