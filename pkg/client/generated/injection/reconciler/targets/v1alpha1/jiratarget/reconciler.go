...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.JiraTarget, desiredFinalizers sets.String) (*v1alpha1.JiraTarget, error) {
	// Don't modify the informers copy.
