...
import (
	...
	jiratarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/jiratarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "jiratarget-controller"
	defaultFinalizerName       = "jiratargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	jiratargetInformer := jiratarget.Get(ctx)

	lister := jiratargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.JiraTarget"),
	)
