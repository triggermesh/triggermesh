...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KafkaTarget, desiredFinalizers sets.String) (*v1alpha1.KafkaTarget, error) {
	// Don't modify the informers copy.
