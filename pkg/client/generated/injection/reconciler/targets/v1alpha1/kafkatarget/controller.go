...
import (
	...
	kafkatarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/kafkatarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "kafkatarget-controller"
	defaultFinalizerName       = "kafkatargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kafkatargetInformer := kafkatarget.Get(ctx)

	lister := kafkatargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.KafkaTarget"),
	)
