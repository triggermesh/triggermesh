...
import (
	...
	awskinesistarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awskinesistarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awskinesistarget-controller"
	defaultFinalizerName       = "awskinesistargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awskinesistargetInformer := awskinesistarget.Get(ctx)

	lister := awskinesistargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSKinesisTarget"),
	)
