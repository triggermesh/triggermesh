...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSKinesisTarget, desiredFinalizers sets.String) (*v1alpha1.AWSKinesisTarget, error) {
	// Don't modify the informers copy.
