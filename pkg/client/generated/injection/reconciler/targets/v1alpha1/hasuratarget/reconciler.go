...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.HasuraTarget, desiredFinalizers sets.String) (*v1alpha1.HasuraTarget, error) {
	// Don't modify the informers copy.
