...
import (
	...
	hasuratarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/hasuratarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "hasuratarget-controller"
	defaultFinalizerName       = "hasuratargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	hasuratargetInformer := hasuratarget.Get(ctx)

	lister := hasuratargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.HasuraTarget"),
	)
