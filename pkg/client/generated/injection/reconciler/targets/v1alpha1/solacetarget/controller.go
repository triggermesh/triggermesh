...
import (
	...
	solacetarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/solacetarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "solacetarget-controller"
	defaultFinalizerName       = "solacetargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	solacetargetInformer := solacetarget.Get(ctx)

	lister := solacetargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.SolaceTarget"),
	)
