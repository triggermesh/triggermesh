...
import (
	...
	googlecloudworkflowstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/googlecloudworkflowstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudworkflowstarget-controller"
	defaultFinalizerName       = "googlecloudworkflowstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudworkflowstargetInformer := googlecloudworkflowstarget.Get(ctx)

	lister := googlecloudworkflowstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.GoogleCloudWorkflowsTarget"),
	)
