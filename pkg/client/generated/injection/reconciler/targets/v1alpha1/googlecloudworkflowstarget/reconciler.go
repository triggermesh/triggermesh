...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudWorkflowsTarget, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudWorkflowsTarget, error) {
	// Don't modify the informers copy.
