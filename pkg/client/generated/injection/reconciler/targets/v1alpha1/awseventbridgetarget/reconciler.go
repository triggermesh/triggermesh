...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSEventBridgeTarget, desiredFinalizers sets.String) (*v1alpha1.AWSEventBridgeTarget, error) {
	// Don't modify the informers copy.
