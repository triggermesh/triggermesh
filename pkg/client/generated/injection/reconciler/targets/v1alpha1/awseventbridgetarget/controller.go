...
import (
	...
	awseventbridgetarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awseventbridgetarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awseventbridgetarget-controller"
	defaultFinalizerName       = "awseventbridgetargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awseventbridgetargetInformer := awseventbridgetarget.Get(ctx)

	lister := awseventbridgetargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSEventBridgeTarget"),
	)
