...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSSQSTarget, desiredFinalizers sets.String) (*v1alpha1.AWSSQSTarget, error) {
	// Don't modify the informers copy.
