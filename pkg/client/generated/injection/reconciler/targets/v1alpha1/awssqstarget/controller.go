...
import (
	...
	awssqstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awssqstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awssqstarget-controller"
	defaultFinalizerName       = "awssqstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awssqstargetInformer := awssqstarget.Get(ctx)

	lister := awssqstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSSQSTarget"),
	)
