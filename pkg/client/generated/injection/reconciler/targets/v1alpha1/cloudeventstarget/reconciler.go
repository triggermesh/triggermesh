...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CloudEventsTarget, desiredFinalizers sets.String) (*v1alpha1.CloudEventsTarget, error) {
	// Don't modify the informers copy.
