...
import (
	...
	cloudeventstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/cloudeventstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "cloudeventstarget-controller"
	defaultFinalizerName       = "cloudeventstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	cloudeventstargetInformer := cloudeventstarget.Get(ctx)

	lister := cloudeventstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.CloudEventsTarget"),
	)
