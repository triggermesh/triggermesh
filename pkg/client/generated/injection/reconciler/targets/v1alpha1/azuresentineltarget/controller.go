...
import (
	...
	azuresentineltarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azuresentineltarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azuresentineltarget-controller"
	defaultFinalizerName       = "azuresentineltargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azuresentineltargetInformer := azuresentineltarget.Get(ctx)

	lister := azuresentineltargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AzureSentinelTarget"),
	)
