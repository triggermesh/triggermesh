...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureSentinelTarget, desiredFinalizers sets.String) (*v1alpha1.AzureSentinelTarget, error) {
	// Don't modify the informers copy.
