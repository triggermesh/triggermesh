...
import (
	...
	azureeventhubstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azureeventhubstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureeventhubstarget-controller"
	defaultFinalizerName       = "azureeventhubstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureeventhubstargetInformer := azureeventhubstarget.Get(ctx)

	lister := azureeventhubstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AzureEventHubsTarget"),
	)
