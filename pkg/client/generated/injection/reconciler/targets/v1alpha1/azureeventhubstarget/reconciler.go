...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureEventHubsTarget, desiredFinalizers sets.String) (*v1alpha1.AzureEventHubsTarget, error) {
	// Don't modify the informers copy.
