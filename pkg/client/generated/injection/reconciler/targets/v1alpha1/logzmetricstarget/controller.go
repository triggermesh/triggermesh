...
import (
	...
	logzmetricstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/logzmetricstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "logzmetricstarget-controller"
	defaultFinalizerName       = "logzmetricstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logzmetricstargetInformer := logzmetricstarget.Get(ctx)

	lister := logzmetricstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.LogzMetricsTarget"),
	)
