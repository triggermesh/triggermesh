...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.LogzMetricsTarget, desiredFinalizers sets.String) (*v1alpha1.LogzMetricsTarget, error) {
	// Don't modify the informers copy.
