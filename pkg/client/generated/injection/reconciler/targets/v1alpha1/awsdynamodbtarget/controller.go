...
import (
	...
	awsdynamodbtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awsdynamodbtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awsdynamodbtarget-controller"
	defaultFinalizerName       = "awsdynamodbtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awsdynamodbtargetInformer := awsdynamodbtarget.Get(ctx)

	lister := awsdynamodbtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSDynamoDBTarget"),
	)
