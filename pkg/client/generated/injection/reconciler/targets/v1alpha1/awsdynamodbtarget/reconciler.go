...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSDynamoDBTarget, desiredFinalizers sets.String) (*v1alpha1.AWSDynamoDBTarget, error) {
	// Don't modify the informers copy.
