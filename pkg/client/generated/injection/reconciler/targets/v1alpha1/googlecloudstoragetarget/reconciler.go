...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.GoogleCloudStorageTarget, desiredFinalizers sets.String) (*v1alpha1.GoogleCloudStorageTarget, error) {
	// Don't modify the informers copy.
