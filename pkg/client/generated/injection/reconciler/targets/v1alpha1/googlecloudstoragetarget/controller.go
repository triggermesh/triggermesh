...
import (
	...
	googlecloudstoragetarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/googlecloudstoragetarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudstoragetarget-controller"
	defaultFinalizerName       = "googlecloudstoragetargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudstoragetargetInformer := googlecloudstoragetarget.Get(ctx)

	lister := googlecloudstoragetargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.GoogleCloudStorageTarget"),
	)
