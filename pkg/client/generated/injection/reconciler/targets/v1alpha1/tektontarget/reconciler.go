...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonTarget, desiredFinalizers sets.String) (*v1alpha1.TektonTarget, error) {
	// Don't modify the informers copy.
