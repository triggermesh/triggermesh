...
import (
	...
	tektontarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/tektontarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektontarget-controller"
	defaultFinalizerName       = "tektontargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektontargetInformer := tektontarget.Get(ctx)

	lister := tektontargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.TektonTarget"),
	)
