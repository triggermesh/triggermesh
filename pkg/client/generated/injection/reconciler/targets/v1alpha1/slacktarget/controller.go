...
import (
	...
	slacktarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/slacktarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "slacktarget-controller"
	defaultFinalizerName       = "slacktargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	slacktargetInformer := slacktarget.Get(ctx)

	lister := slacktargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.SlackTarget"),
	)
