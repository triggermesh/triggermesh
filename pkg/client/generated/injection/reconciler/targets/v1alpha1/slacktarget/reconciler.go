...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SlackTarget, desiredFinalizers sets.String) (*v1alpha1.SlackTarget, error) {
	// Don't modify the informers copy.
