...
import (
	...
	httptarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/httptarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "httptarget-controller"
	defaultFinalizerName       = "httptargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	httptargetInformer := httptarget.Get(ctx)

	lister := httptargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.HTTPTarget"),
	)
