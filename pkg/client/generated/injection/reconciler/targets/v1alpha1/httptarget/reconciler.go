...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.HTTPTarget, desiredFinalizers sets.String) (*v1alpha1.HTTPTarget, error) {
	// Don't modify the informers copy.
