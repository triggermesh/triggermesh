...
import (
	...
	twiliotarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/twiliotarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "twiliotarget-controller"
	defaultFinalizerName       = "twiliotargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	twiliotargetInformer := twiliotarget.Get(ctx)

	lister := twiliotargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.TwilioTarget"),
	)
