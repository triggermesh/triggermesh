...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SendGridTarget, desiredFinalizers sets.String) (*v1alpha1.SendGridTarget, error) {
	// Don't modify the informers copy.
