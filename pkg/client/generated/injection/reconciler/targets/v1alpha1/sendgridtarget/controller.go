...
import (
	...
	sendgridtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/sendgridtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "sendgridtarget-controller"
	defaultFinalizerName       = "sendgridtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	sendgridtargetInformer := sendgridtarget.Get(ctx)

	lister := sendgridtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.SendGridTarget"),
	)
