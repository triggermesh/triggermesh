...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.InfraTarget, desiredFinalizers sets.String) (*v1alpha1.InfraTarget, error) {
	// Don't modify the informers copy.
