...
import (
	...
	infratarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/infratarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "infratarget-controller"
	defaultFinalizerName       = "infratargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	infratargetInformer := infratarget.Get(ctx)

	lister := infratargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.InfraTarget"),
	)
