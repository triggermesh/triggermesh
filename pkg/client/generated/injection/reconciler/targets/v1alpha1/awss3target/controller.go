...
import (
	...
	awss3target "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awss3target"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awss3target-controller"
	defaultFinalizerName       = "awss3targets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awss3targetInformer := awss3target.Get(ctx)

	lister := awss3targetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSS3Target"),
	)
