...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSS3Target, desiredFinalizers sets.String) (*v1alpha1.AWSS3Target, error) {
	// Don't modify the informers copy.
