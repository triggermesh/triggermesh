...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.DatadogTarget, desiredFinalizers sets.String) (*v1alpha1.DatadogTarget, error) {
	// Don't modify the informers copy.
