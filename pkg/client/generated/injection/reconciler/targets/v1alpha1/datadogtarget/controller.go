...
import (
	...
	datadogtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/datadogtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "datadogtarget-controller"
	defaultFinalizerName       = "datadogtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	datadogtargetInformer := datadogtarget.Get(ctx)

	lister := datadogtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.DatadogTarget"),
	)
