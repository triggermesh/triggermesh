...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSSNSTarget, desiredFinalizers sets.String) (*v1alpha1.AWSSNSTarget, error) {
	// Don't modify the informers copy.
