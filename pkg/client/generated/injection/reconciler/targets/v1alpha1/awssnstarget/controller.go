...
import (
	...
	awssnstarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awssnstarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awssnstarget-controller"
	defaultFinalizerName       = "awssnstargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awssnstargetInformer := awssnstarget.Get(ctx)

	lister := awssnstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSSNSTarget"),
	)
