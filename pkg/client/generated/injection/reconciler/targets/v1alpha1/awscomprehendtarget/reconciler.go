...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AWSComprehendTarget, desiredFinalizers sets.String) (*v1alpha1.AWSComprehendTarget, error) {
	// Don't modify the informers copy.
