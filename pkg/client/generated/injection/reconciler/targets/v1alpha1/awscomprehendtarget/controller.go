...
import (
	...
	awscomprehendtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awscomprehendtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "awscomprehendtarget-controller"
	defaultFinalizerName       = "awscomprehendtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscomprehendtargetInformer := awscomprehendtarget.Get(ctx)

	lister := awscomprehendtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AWSComprehendTarget"),
	)
