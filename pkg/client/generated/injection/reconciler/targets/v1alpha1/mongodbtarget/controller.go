...
import (
	...
	mongodbtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/mongodbtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "mongodbtarget-controller"
	defaultFinalizerName       = "mongodbtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	mongodbtargetInformer := mongodbtarget.Get(ctx)

	lister := mongodbtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.MongoDBTarget"),
	)
