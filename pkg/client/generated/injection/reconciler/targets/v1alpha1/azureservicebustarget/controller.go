...
import (
	...
	azureservicebustarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azureservicebustarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "azureservicebustarget-controller"
	defaultFinalizerName       = "azureservicebustargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azureservicebustargetInformer := azureservicebustarget.Get(ctx)

	lister := azureservicebustargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.AzureServiceBusTarget"),
	)
