...
import (
	...
	confluenttarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/confluenttarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "confluenttarget-controller"
	defaultFinalizerName       = "confluenttargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	confluenttargetInformer := confluenttarget.Get(ctx)

	lister := confluenttargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.ConfluentTarget"),
	)
