...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ConfluentTarget, desiredFinalizers sets.String) (*v1alpha1.ConfluentTarget, error) {
	// Don't modify the informers copy.
