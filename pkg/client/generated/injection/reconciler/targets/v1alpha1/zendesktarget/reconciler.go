...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ZendeskTarget, desiredFinalizers sets.String) (*v1alpha1.ZendeskTarget, error) {
	// Don't modify the informers copy.
