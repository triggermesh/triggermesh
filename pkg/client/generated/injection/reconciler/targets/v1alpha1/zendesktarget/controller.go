...
import (
	...
	zendesktarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/zendesktarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "zendesktarget-controller"
	defaultFinalizerName       = "zendesktargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	zendesktargetInformer := zendesktarget.Get(ctx)

	lister := zendesktargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.ZendeskTarget"),
	)
