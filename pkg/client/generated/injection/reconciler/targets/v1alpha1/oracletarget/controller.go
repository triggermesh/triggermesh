...
import (
	...
	oracletarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/oracletarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "oracletarget-controller"
	defaultFinalizerName       = "oracletargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	oracletargetInformer := oracletarget.Get(ctx)

	lister := oracletargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.OracleTarget"),
	)
