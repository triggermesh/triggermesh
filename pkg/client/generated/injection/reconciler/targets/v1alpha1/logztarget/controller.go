...
import (
	...
	logztarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/logztarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "logztarget-controller"
	defaultFinalizerName       = "logztargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logztargetInformer := logztarget.Get(ctx)

	lister := logztargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.LogzTarget"),
	)
