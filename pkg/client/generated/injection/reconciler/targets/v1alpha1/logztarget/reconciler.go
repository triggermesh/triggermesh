...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.LogzTarget, desiredFinalizers sets.String) (*v1alpha1.LogzTarget, error) {
	// Don't modify the informers copy.
