...
import (
	...
	uipathtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/uipathtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "uipathtarget-controller"
	defaultFinalizerName       = "uipathtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	uipathtargetInformer := uipathtarget.Get(ctx)

	lister := uipathtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.UiPathTarget"),
	)
