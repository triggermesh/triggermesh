...
import (
	...
	splunktarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/splunktarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "splunktarget-controller"
	defaultFinalizerName       = "splunktargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	splunktargetInformer := splunktarget.Get(ctx)

	lister := splunktargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.SplunkTarget"),
	)
