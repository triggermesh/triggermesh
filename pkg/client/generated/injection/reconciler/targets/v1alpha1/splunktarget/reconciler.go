...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SplunkTarget, desiredFinalizers sets.String) (*v1alpha1.SplunkTarget, error) {
	// Don't modify the informers copy.
