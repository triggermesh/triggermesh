...
import (
	...
	googlecloudpubsubtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/googlecloudpubsubtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "googlecloudpubsubtarget-controller"
	defaultFinalizerName       = "googlecloudpubsubtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	googlecloudpubsubtargetInformer := googlecloudpubsubtarget.Get(ctx)

	lister := googlecloudpubsubtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.GoogleCloudPubSubTarget"),
	)
