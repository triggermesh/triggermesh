...
import (
	...
	elasticsearchtarget "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/elasticsearchtarget"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "elasticsearchtarget-controller"
	defaultFinalizerName       = "elasticsearchtargets.targets.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	elasticsearchtargetInformer := elasticsearchtarget.Get(ctx)

	lister := elasticsearchtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.triggermesh.io.ElasticsearchTarget"),
	)
