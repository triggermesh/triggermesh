...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ElasticsearchTarget, desiredFinalizers sets.String) (*v1alpha1.ElasticsearchTarget, error) {
	// Don't modify the informers copy.
