...
func Get(ctx context.Context) v1alpha1.AWSCloudWatchLogsSourceInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/triggermesh/pkg/client/generated/informers/externalversions/sources/v1alpha1.AWSCloudWatchLogsSourceInformer from context.")
	}
