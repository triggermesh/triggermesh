...
func Get(ctx context.Context, selector string) v1alpha1.AWSCloudWatchLogsSourceInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/triggermesh/triggermesh/pkg/client/generated/informers/externalversions/sources/v1alpha1.AWSCloudWatchLogsSourceInformer with selector %s from context.", selector)
	}
