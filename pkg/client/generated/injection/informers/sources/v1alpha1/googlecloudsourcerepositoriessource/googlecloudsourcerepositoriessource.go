...
func Get(ctx context.Context) v1alpha1.GoogleCloudSourceRepositoriesSourceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/triggermesh/pkg/client/generated/informers/externalversions/sources/v1alpha1.GoogleCloudSourceRepositoriesSourceInformer from context.")
	}
