...
func Get(ctx context.Context, selector string) v1alpha1.OracleTargetInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/triggermesh/triggermesh/pkg/client/generated/informers/externalversions/targets/v1alpha1.OracleTargetInformer with selector %s from context.", selector)
	}
