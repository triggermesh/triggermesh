...
func Get(ctx context.Context) v1alpha1.DataWeaveTransformationInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/triggermesh/pkg/client/generated/informers/externalversions/flow/v1alpha1.DataWeaveTransformationInformer from context.")
	}
