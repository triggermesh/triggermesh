...
func (c *jQTransformations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JQTransformation, err error) {
	result = &v1alpha1.JQTransformation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *jQTransformations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JQTransformationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JQTransformationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jqtransformations").
...
func (c *jQTransformations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *jQTransformations) Create(ctx context.Context, jQTransformation *v1alpha1.JQTransformation, opts v1.CreateOptions) (result *v1alpha1.JQTransformation, err error) {
	result = &v1alpha1.JQTransformation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("jqtransformations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jQTransformation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *jQTransformations) Update(ctx context.Context, jQTransformation *v1alpha1.JQTransformation, opts v1.UpdateOptions) (result *v1alpha1.JQTransformation, err error) {
	result = &v1alpha1.JQTransformation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jqtransformations").
		Name(jQTransformation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jQTransformation).
		Do(ctx).
		Into(result)
...
func (c *jQTransformations) UpdateStatus(ctx context.Context, jQTransformation *v1alpha1.JQTransformation, opts v1.UpdateOptions) (result *v1alpha1.JQTransformation, err error) {
	result = &v1alpha1.JQTransformation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jqtransformations").
...
func (c *jQTransformations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *jQTransformations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *jQTransformations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JQTransformation, err error) {
	result = &v1alpha1.JQTransformation{}
