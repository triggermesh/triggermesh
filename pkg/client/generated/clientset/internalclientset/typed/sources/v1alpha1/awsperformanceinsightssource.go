...
// AWSPerformanceInsightsSourcesGetter has a method to return a AWSPerformanceInsightsSourceInterface.
...
// aWSPerformanceInsightsSources implements AWSPerformanceInsightsSourceInterface
type aWSPerformanceInsightsSources struct {
	client rest.Interface
	ns     string
}

// newAWSPerformanceInsightsSources returns a AWSPerformanceInsightsSources
func newAWSPerformanceInsightsSources(c *SourcesV1alpha1Client, namespace string) *aWSPerformanceInsightsSources {
	return &aWSPerformanceInsightsSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *aWSPerformanceInsightsSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AWSPerformanceInsightsSource, err error) {
	result = &v1alpha1.AWSPerformanceInsightsSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aWSPerformanceInsightsSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AWSPerformanceInsightsSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AWSPerformanceInsightsSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsperformanceinsightssources").
...
func (c *aWSPerformanceInsightsSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aWSPerformanceInsightsSources) Create(ctx context.Context, aWSPerformanceInsightsSource *v1alpha1.AWSPerformanceInsightsSource, opts v1.CreateOptions) (result *v1alpha1.AWSPerformanceInsightsSource, err error) {
	result = &v1alpha1.AWSPerformanceInsightsSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsperformanceinsightssources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSPerformanceInsightsSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *aWSPerformanceInsightsSources) Update(ctx context.Context, aWSPerformanceInsightsSource *v1alpha1.AWSPerformanceInsightsSource, opts v1.UpdateOptions) (result *v1alpha1.AWSPerformanceInsightsSource, err error) {
	result = &v1alpha1.AWSPerformanceInsightsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsperformanceinsightssources").
		Name(aWSPerformanceInsightsSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSPerformanceInsightsSource).
		Do(ctx).
		Into(result)
...
func (c *aWSPerformanceInsightsSources) UpdateStatus(ctx context.Context, aWSPerformanceInsightsSource *v1alpha1.AWSPerformanceInsightsSource, opts v1.UpdateOptions) (result *v1alpha1.AWSPerformanceInsightsSource, err error) {
	result = &v1alpha1.AWSPerformanceInsightsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsperformanceinsightssources").
...
func (c *aWSPerformanceInsightsSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aWSPerformanceInsightsSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aWSPerformanceInsightsSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSPerformanceInsightsSource, err error) {
	result = &v1alpha1.AWSPerformanceInsightsSource{}
