...
// IBMMQSourcesGetter has a method to return a IBMMQSourceInterface.
...
// iBMMQSources implements IBMMQSourceInterface
type iBMMQSources struct {
	client rest.Interface
	ns     string
}

// newIBMMQSources returns a IBMMQSources
func newIBMMQSources(c *SourcesV1alpha1Client, namespace string) *iBMMQSources {
	return &iBMMQSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *iBMMQSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IBMMQSource, err error) {
	result = &v1alpha1.IBMMQSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iBMMQSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IBMMQSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IBMMQSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ibmmqsources").
...
func (c *iBMMQSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iBMMQSources) Create(ctx context.Context, iBMMQSource *v1alpha1.IBMMQSource, opts v1.CreateOptions) (result *v1alpha1.IBMMQSource, err error) {
	result = &v1alpha1.IBMMQSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ibmmqsources").
...
func (c *iBMMQSources) Update(ctx context.Context, iBMMQSource *v1alpha1.IBMMQSource, opts v1.UpdateOptions) (result *v1alpha1.IBMMQSource, err error) {
	result = &v1alpha1.IBMMQSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ibmmqsources").
		Name(iBMMQSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iBMMQSource).
		Do(ctx).
		Into(result)
...
func (c *iBMMQSources) UpdateStatus(ctx context.Context, iBMMQSource *v1alpha1.IBMMQSource, opts v1.UpdateOptions) (result *v1alpha1.IBMMQSource, err error) {
	result = &v1alpha1.IBMMQSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ibmmqsources").
...
func (c *iBMMQSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iBMMQSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iBMMQSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IBMMQSource, err error) {
	result = &v1alpha1.IBMMQSource{}
