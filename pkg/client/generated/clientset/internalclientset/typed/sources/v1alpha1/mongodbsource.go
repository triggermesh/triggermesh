...
func (c *mongoDBSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoDBSource, err error) {
...
func (c *mongoDBSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoDBSourceList, err error) {
...
func (c *mongoDBSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mongoDBSources) Create(ctx context.Context, mongoDBSource *v1alpha1.MongoDBSource, opts v1.CreateOptions) (result *v1alpha1.MongoDBSource, err error) {
	result = &v1alpha1.MongoDBSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongodbsources").
...
func (c *mongoDBSources) Update(ctx context.Context, mongoDBSource *v1alpha1.MongoDBSource, opts v1.UpdateOptions) (result *v1alpha1.MongoDBSource, err error) {
	result = &v1alpha1.MongoDBSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbsources").
...
func (c *mongoDBSources) UpdateStatus(ctx context.Context, mongoDBSource *v1alpha1.MongoDBSource, opts v1.UpdateOptions) (result *v1alpha1.MongoDBSource, err error) {
	result = &v1alpha1.MongoDBSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbsources").
...
func (c *mongoDBSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mongoDBSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mongoDBSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoDBSource, err error) {
	result = &v1alpha1.MongoDBSource{}
