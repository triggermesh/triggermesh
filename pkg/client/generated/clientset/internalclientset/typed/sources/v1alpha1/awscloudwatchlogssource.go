...
// AWSCloudWatchLogsSourcesGetter has a method to return a AWSCloudWatchLogsSourceInterface.
...
// aWSCloudWatchLogsSources implements AWSCloudWatchLogsSourceInterface
type aWSCloudWatchLogsSources struct {
	client rest.Interface
	ns     string
}

// newAWSCloudWatchLogsSources returns a AWSCloudWatchLogsSources
func newAWSCloudWatchLogsSources(c *SourcesV1alpha1Client, namespace string) *aWSCloudWatchLogsSources {
	return &aWSCloudWatchLogsSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *aWSCloudWatchLogsSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AWSCloudWatchLogsSource, err error) {
	result = &v1alpha1.AWSCloudWatchLogsSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aWSCloudWatchLogsSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AWSCloudWatchLogsSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AWSCloudWatchLogsSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awscloudwatchlogssources").
...
func (c *aWSCloudWatchLogsSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aWSCloudWatchLogsSources) Create(ctx context.Context, aWSCloudWatchLogsSource *v1alpha1.AWSCloudWatchLogsSource, opts v1.CreateOptions) (result *v1alpha1.AWSCloudWatchLogsSource, err error) {
	result = &v1alpha1.AWSCloudWatchLogsSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awscloudwatchlogssources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSCloudWatchLogsSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *aWSCloudWatchLogsSources) Update(ctx context.Context, aWSCloudWatchLogsSource *v1alpha1.AWSCloudWatchLogsSource, opts v1.UpdateOptions) (result *v1alpha1.AWSCloudWatchLogsSource, err error) {
	result = &v1alpha1.AWSCloudWatchLogsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awscloudwatchlogssources").
		Name(aWSCloudWatchLogsSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSCloudWatchLogsSource).
		Do(ctx).
		Into(result)
...
func (c *aWSCloudWatchLogsSources) UpdateStatus(ctx context.Context, aWSCloudWatchLogsSource *v1alpha1.AWSCloudWatchLogsSource, opts v1.UpdateOptions) (result *v1alpha1.AWSCloudWatchLogsSource, err error) {
	result = &v1alpha1.AWSCloudWatchLogsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awscloudwatchlogssources").
...
func (c *aWSCloudWatchLogsSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aWSCloudWatchLogsSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aWSCloudWatchLogsSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSCloudWatchLogsSource, err error) {
	result = &v1alpha1.AWSCloudWatchLogsSource{}
