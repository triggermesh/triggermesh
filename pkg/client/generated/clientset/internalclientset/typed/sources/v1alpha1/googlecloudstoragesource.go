...
// GoogleCloudStorageSourcesGetter has a method to return a GoogleCloudStorageSourceInterface.
...
// googleCloudStorageSources implements GoogleCloudStorageSourceInterface
type googleCloudStorageSources struct {
	client rest.Interface
	ns     string
}

// newGoogleCloudStorageSources returns a GoogleCloudStorageSources
...
func (c *googleCloudStorageSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GoogleCloudStorageSource, err error) {
...
func (c *googleCloudStorageSources) Update(ctx context.Context, googleCloudStorageSource *v1alpha1.GoogleCloudStorageSource, opts v1.UpdateOptions) (result *v1alpha1.GoogleCloudStorageSource, err error) {
	result = &v1alpha1.GoogleCloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("googlecloudstoragesources").
		Name(googleCloudStorageSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(googleCloudStorageSource).
		Do(ctx).
		Into(result)
...
func (c *googleCloudStorageSources) UpdateStatus(ctx context.Context, googleCloudStorageSource *v1alpha1.GoogleCloudStorageSource, opts v1.UpdateOptions) (result *v1alpha1.GoogleCloudStorageSource, err error) {
	result = &v1alpha1.GoogleCloudStorageSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("googlecloudstoragesources").
...
func (c *googleCloudStorageSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GoogleCloudStorageSource, err error) {
	result = &v1alpha1.GoogleCloudStorageSource{}
