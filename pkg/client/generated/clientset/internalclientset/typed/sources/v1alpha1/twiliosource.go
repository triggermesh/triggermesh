...
// TwilioSourcesGetter has a method to return a TwilioSourceInterface.
...
// twilioSources implements TwilioSourceInterface
type twilioSources struct {
	client rest.Interface
	ns     string
}

// newTwilioSources returns a TwilioSources
func newTwilioSources(c *SourcesV1alpha1Client, namespace string) *twilioSources {
	return &twilioSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *twilioSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TwilioSource, err error) {
	result = &v1alpha1.TwilioSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *twilioSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TwilioSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TwilioSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("twiliosources").
...
func (c *twilioSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *twilioSources) Create(ctx context.Context, twilioSource *v1alpha1.TwilioSource, opts v1.CreateOptions) (result *v1alpha1.TwilioSource, err error) {
	result = &v1alpha1.TwilioSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("twiliosources").
...
func (c *twilioSources) Update(ctx context.Context, twilioSource *v1alpha1.TwilioSource, opts v1.UpdateOptions) (result *v1alpha1.TwilioSource, err error) {
	result = &v1alpha1.TwilioSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twiliosources").
		Name(twilioSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(twilioSource).
		Do(ctx).
		Into(result)
...
func (c *twilioSources) UpdateStatus(ctx context.Context, twilioSource *v1alpha1.TwilioSource, opts v1.UpdateOptions) (result *v1alpha1.TwilioSource, err error) {
	result = &v1alpha1.TwilioSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twiliosources").
...
func (c *twilioSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *twilioSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *twilioSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TwilioSource, err error) {
	result = &v1alpha1.TwilioSource{}
