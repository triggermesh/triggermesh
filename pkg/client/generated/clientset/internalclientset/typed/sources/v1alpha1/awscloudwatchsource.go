...
// AWSCloudWatchSourcesGetter has a method to return a AWSCloudWatchSourceInterface.
...
// aWSCloudWatchSources implements AWSCloudWatchSourceInterface
type aWSCloudWatchSources struct {
	client rest.Interface
	ns     string
}

// newAWSCloudWatchSources returns a AWSCloudWatchSources
func newAWSCloudWatchSources(c *SourcesV1alpha1Client, namespace string) *aWSCloudWatchSources {
	return &aWSCloudWatchSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *aWSCloudWatchSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AWSCloudWatchSource, err error) {
	result = &v1alpha1.AWSCloudWatchSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aWSCloudWatchSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AWSCloudWatchSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AWSCloudWatchSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awscloudwatchsources").
...
func (c *aWSCloudWatchSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aWSCloudWatchSources) Create(ctx context.Context, aWSCloudWatchSource *v1alpha1.AWSCloudWatchSource, opts v1.CreateOptions) (result *v1alpha1.AWSCloudWatchSource, err error) {
	result = &v1alpha1.AWSCloudWatchSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awscloudwatchsources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSCloudWatchSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *aWSCloudWatchSources) Update(ctx context.Context, aWSCloudWatchSource *v1alpha1.AWSCloudWatchSource, opts v1.UpdateOptions) (result *v1alpha1.AWSCloudWatchSource, err error) {
	result = &v1alpha1.AWSCloudWatchSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awscloudwatchsources").
		Name(aWSCloudWatchSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aWSCloudWatchSource).
		Do(ctx).
		Into(result)
...
func (c *aWSCloudWatchSources) UpdateStatus(ctx context.Context, aWSCloudWatchSource *v1alpha1.AWSCloudWatchSource, opts v1.UpdateOptions) (result *v1alpha1.AWSCloudWatchSource, err error) {
	result = &v1alpha1.AWSCloudWatchSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awscloudwatchsources").
...
func (c *aWSCloudWatchSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aWSCloudWatchSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aWSCloudWatchSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSCloudWatchSource, err error) {
	result = &v1alpha1.AWSCloudWatchSource{}
