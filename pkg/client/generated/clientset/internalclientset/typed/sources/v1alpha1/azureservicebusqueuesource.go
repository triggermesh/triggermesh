...
func (c *azureServiceBusQueueSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AzureServiceBusQueueSource, err error) {
	result = &v1alpha1.AzureServiceBusQueueSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *azureServiceBusQueueSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureServiceBusQueueSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AzureServiceBusQueueSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("azureservicebusqueuesources").
...
func (c *azureServiceBusQueueSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureServiceBusQueueSources) Create(ctx context.Context, azureServiceBusQueueSource *v1alpha1.AzureServiceBusQueueSource, opts v1.CreateOptions) (result *v1alpha1.AzureServiceBusQueueSource, err error) {
	result = &v1alpha1.AzureServiceBusQueueSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azureservicebusqueuesources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(azureServiceBusQueueSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *azureServiceBusQueueSources) Update(ctx context.Context, azureServiceBusQueueSource *v1alpha1.AzureServiceBusQueueSource, opts v1.UpdateOptions) (result *v1alpha1.AzureServiceBusQueueSource, err error) {
	result = &v1alpha1.AzureServiceBusQueueSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureservicebusqueuesources").
		Name(azureServiceBusQueueSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(azureServiceBusQueueSource).
		Do(ctx).
		Into(result)
...
func (c *azureServiceBusQueueSources) UpdateStatus(ctx context.Context, azureServiceBusQueueSource *v1alpha1.AzureServiceBusQueueSource, opts v1.UpdateOptions) (result *v1alpha1.AzureServiceBusQueueSource, err error) {
	result = &v1alpha1.AzureServiceBusQueueSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureservicebusqueuesources").
...
func (c *azureServiceBusQueueSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azureServiceBusQueueSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azureServiceBusQueueSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AzureServiceBusQueueSource, err error) {
	result = &v1alpha1.AzureServiceBusQueueSource{}
