...
func (c *azureServiceBusTopicSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AzureServiceBusTopicSource, err error) {
	result = &v1alpha1.AzureServiceBusTopicSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *azureServiceBusTopicSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureServiceBusTopicSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AzureServiceBusTopicSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("azureservicebustopicsources").
...
func (c *azureServiceBusTopicSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureServiceBusTopicSources) Create(ctx context.Context, azureServiceBusTopicSource *v1alpha1.AzureServiceBusTopicSource, opts v1.CreateOptions) (result *v1alpha1.AzureServiceBusTopicSource, err error) {
	result = &v1alpha1.AzureServiceBusTopicSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azureservicebustopicsources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(azureServiceBusTopicSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *azureServiceBusTopicSources) Update(ctx context.Context, azureServiceBusTopicSource *v1alpha1.AzureServiceBusTopicSource, opts v1.UpdateOptions) (result *v1alpha1.AzureServiceBusTopicSource, err error) {
	result = &v1alpha1.AzureServiceBusTopicSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureservicebustopicsources").
		Name(azureServiceBusTopicSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(azureServiceBusTopicSource).
		Do(ctx).
		Into(result)
...
func (c *azureServiceBusTopicSources) UpdateStatus(ctx context.Context, azureServiceBusTopicSource *v1alpha1.AzureServiceBusTopicSource, opts v1.UpdateOptions) (result *v1alpha1.AzureServiceBusTopicSource, err error) {
	result = &v1alpha1.AzureServiceBusTopicSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureservicebustopicsources").
...
func (c *azureServiceBusTopicSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azureServiceBusTopicSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azureServiceBusTopicSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AzureServiceBusTopicSource, err error) {
	result = &v1alpha1.AzureServiceBusTopicSource{}
