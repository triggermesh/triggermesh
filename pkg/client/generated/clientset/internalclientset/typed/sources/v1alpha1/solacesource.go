...
// SolaceSourcesGetter has a method to return a SolaceSourceInterface.
...
// solaceSources implements SolaceSourceInterface
type solaceSources struct {
	client rest.Interface
	ns     string
}

// newSolaceSources returns a SolaceSources
func newSolaceSources(c *SourcesV1alpha1Client, namespace string) *solaceSources {
	return &solaceSources{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *solaceSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SolaceSource, err error) {
	result = &v1alpha1.SolaceSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *solaceSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SolaceSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SolaceSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("solacesources").
...
func (c *solaceSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *solaceSources) Create(ctx context.Context, solaceSource *v1alpha1.SolaceSource, opts v1.CreateOptions) (result *v1alpha1.SolaceSource, err error) {
	result = &v1alpha1.SolaceSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("solacesources").
...
func (c *solaceSources) Update(ctx context.Context, solaceSource *v1alpha1.SolaceSource, opts v1.UpdateOptions) (result *v1alpha1.SolaceSource, err error) {
	result = &v1alpha1.SolaceSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("solacesources").
		Name(solaceSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(solaceSource).
		Do(ctx).
		Into(result)
...
func (c *solaceSources) UpdateStatus(ctx context.Context, solaceSource *v1alpha1.SolaceSource, opts v1.UpdateOptions) (result *v1alpha1.SolaceSource, err error) {
	result = &v1alpha1.SolaceSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("solacesources").
...
func (c *solaceSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *solaceSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *solaceSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SolaceSource, err error) {
	result = &v1alpha1.SolaceSource{}
