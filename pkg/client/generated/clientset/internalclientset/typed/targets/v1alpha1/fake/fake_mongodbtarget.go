...
var mongodbtargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "mongodbtargets"}

var mongodbtargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "MongoDBTarget"}
...
func (c *FakeMongoDBTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoDBTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(mongodbtargetsResource, c.ns, name), &v1alpha1.MongoDBTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MongoDBTarget), err
}
...
func (c *FakeMongoDBTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoDBTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(mongodbtargetsResource, mongodbtargetsKind, c.ns, opts), &v1alpha1.MongoDBTargetList{})
	...
	list := &v1alpha1.MongoDBTargetList{ListMeta: obj.(*v1alpha1.MongoDBTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.MongoDBTargetList).Items {
...
func (c *FakeMongoDBTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(mongodbtargetsResource, c.ns, opts))
...
func (c *FakeMongoDBTargets) Create(ctx context.Context, mongoDBTarget *v1alpha1.MongoDBTarget, opts v1.CreateOptions) (result *v1alpha1.MongoDBTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(mongodbtargetsResource, c.ns, mongoDBTarget), &v1alpha1.MongoDBTarget{})
...
func (c *FakeMongoDBTargets) Update(ctx context.Context, mongoDBTarget *v1alpha1.MongoDBTarget, opts v1.UpdateOptions) (result *v1alpha1.MongoDBTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(mongodbtargetsResource, c.ns, mongoDBTarget), &v1alpha1.MongoDBTarget{})
...
func (c *FakeMongoDBTargets) UpdateStatus(ctx context.Context, mongoDBTarget *v1alpha1.MongoDBTarget, opts v1.UpdateOptions) (*v1alpha1.MongoDBTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(mongodbtargetsResource, "status", c.ns, mongoDBTarget), &v1alpha1.MongoDBTarget{})
...
func (c *FakeMongoDBTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(mongodbtargetsResource, c.ns, name, opts), &v1alpha1.MongoDBTarget{})
...
func (c *FakeMongoDBTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(mongodbtargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.MongoDBTargetList{})
	return err
}
...
func (c *FakeMongoDBTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoDBTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(mongodbtargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.MongoDBTarget{})
