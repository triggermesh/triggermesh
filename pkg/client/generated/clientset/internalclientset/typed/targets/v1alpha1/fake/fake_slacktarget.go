...
var slacktargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "slacktargets"}

var slacktargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "SlackTarget"}
...
func (c *FakeSlackTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SlackTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(slacktargetsResource, c.ns, name), &v1alpha1.SlackTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SlackTarget), err
}
...
func (c *FakeSlackTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SlackTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(slacktargetsResource, slacktargetsKind, c.ns, opts), &v1alpha1.SlackTargetList{})
	...
	list := &v1alpha1.SlackTargetList{ListMeta: obj.(*v1alpha1.SlackTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.SlackTargetList).Items {
...
func (c *FakeSlackTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(slacktargetsResource, c.ns, opts))
...
func (c *FakeSlackTargets) Create(ctx context.Context, slackTarget *v1alpha1.SlackTarget, opts v1.CreateOptions) (result *v1alpha1.SlackTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(slacktargetsResource, c.ns, slackTarget), &v1alpha1.SlackTarget{})
...
func (c *FakeSlackTargets) Update(ctx context.Context, slackTarget *v1alpha1.SlackTarget, opts v1.UpdateOptions) (result *v1alpha1.SlackTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(slacktargetsResource, c.ns, slackTarget), &v1alpha1.SlackTarget{})
...
func (c *FakeSlackTargets) UpdateStatus(ctx context.Context, slackTarget *v1alpha1.SlackTarget, opts v1.UpdateOptions) (*v1alpha1.SlackTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(slacktargetsResource, "status", c.ns, slackTarget), &v1alpha1.SlackTarget{})
...
func (c *FakeSlackTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(slacktargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.SlackTargetList{})
	return err
}
...
func (c *FakeSlackTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SlackTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(slacktargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.SlackTarget{})
