...
var solacetargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "solacetargets"}

var solacetargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "SolaceTarget"}
...
func (c *FakeSolaceTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SolaceTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(solacetargetsResource, c.ns, name), &v1alpha1.SolaceTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SolaceTarget), err
}
...
func (c *FakeSolaceTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SolaceTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(solacetargetsResource, solacetargetsKind, c.ns, opts), &v1alpha1.SolaceTargetList{})
	...
	list := &v1alpha1.SolaceTargetList{ListMeta: obj.(*v1alpha1.SolaceTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.SolaceTargetList).Items {
...
func (c *FakeSolaceTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(solacetargetsResource, c.ns, opts))
...
func (c *FakeSolaceTargets) Create(ctx context.Context, solaceTarget *v1alpha1.SolaceTarget, opts v1.CreateOptions) (result *v1alpha1.SolaceTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(solacetargetsResource, c.ns, solaceTarget), &v1alpha1.SolaceTarget{})
...
func (c *FakeSolaceTargets) Update(ctx context.Context, solaceTarget *v1alpha1.SolaceTarget, opts v1.UpdateOptions) (result *v1alpha1.SolaceTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(solacetargetsResource, c.ns, solaceTarget), &v1alpha1.SolaceTarget{})
...
func (c *FakeSolaceTargets) UpdateStatus(ctx context.Context, solaceTarget *v1alpha1.SolaceTarget, opts v1.UpdateOptions) (*v1alpha1.SolaceTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(solacetargetsResource, "status", c.ns, solaceTarget), &v1alpha1.SolaceTarget{})
...
func (c *FakeSolaceTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(solacetargetsResource, c.ns, name, opts), &v1alpha1.SolaceTarget{})
...
func (c *FakeSolaceTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(solacetargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.SolaceTargetList{})
	return err
}
...
func (c *FakeSolaceTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SolaceTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(solacetargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.SolaceTarget{})
