...
func (c *logzMetricsTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogzMetricsTarget, err error) {
	result = &v1alpha1.LogzMetricsTarget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *logzMetricsTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogzMetricsTargetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LogzMetricsTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logzmetricstargets").
...
func (c *logzMetricsTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logzMetricsTargets) Create(ctx context.Context, logzMetricsTarget *v1alpha1.LogzMetricsTarget, opts v1.CreateOptions) (result *v1alpha1.LogzMetricsTarget, err error) {
	result = &v1alpha1.LogzMetricsTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logzmetricstargets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(logzMetricsTarget).
		Do(ctx).
		Into(result)
	return
}
...
func (c *logzMetricsTargets) Update(ctx context.Context, logzMetricsTarget *v1alpha1.LogzMetricsTarget, opts v1.UpdateOptions) (result *v1alpha1.LogzMetricsTarget, err error) {
	result = &v1alpha1.LogzMetricsTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logzmetricstargets").
		Name(logzMetricsTarget.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(logzMetricsTarget).
		Do(ctx).
		Into(result)
...
func (c *logzMetricsTargets) UpdateStatus(ctx context.Context, logzMetricsTarget *v1alpha1.LogzMetricsTarget, opts v1.UpdateOptions) (result *v1alpha1.LogzMetricsTarget, err error) {
	result = &v1alpha1.LogzMetricsTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logzmetricstargets").
...
func (c *logzMetricsTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logzMetricsTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logzMetricsTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogzMetricsTarget, err error) {
	result = &v1alpha1.LogzMetricsTarget{}
