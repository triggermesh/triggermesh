...
var zendesktargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "zendesktargets"}

var zendesktargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "ZendeskTarget"}
...
func (c *FakeZendeskTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ZendeskTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(zendesktargetsResource, c.ns, name), &v1alpha1.ZendeskTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ZendeskTarget), err
}
...
func (c *FakeZendeskTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ZendeskTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(zendesktargetsResource, zendesktargetsKind, c.ns, opts), &v1alpha1.ZendeskTargetList{})
	...
	list := &v1alpha1.ZendeskTargetList{ListMeta: obj.(*v1alpha1.ZendeskTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.ZendeskTargetList).Items {
...
func (c *FakeZendeskTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(zendesktargetsResource, c.ns, opts))
...
func (c *FakeZendeskTargets) Create(ctx context.Context, zendeskTarget *v1alpha1.ZendeskTarget, opts v1.CreateOptions) (result *v1alpha1.ZendeskTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(zendesktargetsResource, c.ns, zendeskTarget), &v1alpha1.ZendeskTarget{})
...
func (c *FakeZendeskTargets) Update(ctx context.Context, zendeskTarget *v1alpha1.ZendeskTarget, opts v1.UpdateOptions) (result *v1alpha1.ZendeskTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(zendesktargetsResource, c.ns, zendeskTarget), &v1alpha1.ZendeskTarget{})
...
func (c *FakeZendeskTargets) UpdateStatus(ctx context.Context, zendeskTarget *v1alpha1.ZendeskTarget, opts v1.UpdateOptions) (*v1alpha1.ZendeskTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(zendesktargetsResource, "status", c.ns, zendeskTarget), &v1alpha1.ZendeskTarget{})
...
func (c *FakeZendeskTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(zendesktargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ZendeskTargetList{})
	return err
}
...
func (c *FakeZendeskTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ZendeskTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(zendesktargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ZendeskTarget{})
