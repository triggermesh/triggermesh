...
var awssqstargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "awssqstargets"}

var awssqstargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "AWSSQSTarget"}
...
func (c *FakeAWSSQSTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AWSSQSTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssqstargetsResource, c.ns, name), &v1alpha1.AWSSQSTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AWSSQSTarget), err
}
...
func (c *FakeAWSSQSTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AWSSQSTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssqstargetsResource, awssqstargetsKind, c.ns, opts), &v1alpha1.AWSSQSTargetList{})
	...
	list := &v1alpha1.AWSSQSTargetList{ListMeta: obj.(*v1alpha1.AWSSQSTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.AWSSQSTargetList).Items {
...
func (c *FakeAWSSQSTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(awssqstargetsResource, c.ns, opts))
...
func (c *FakeAWSSQSTargets) Create(ctx context.Context, aWSSQSTarget *v1alpha1.AWSSQSTarget, opts v1.CreateOptions) (result *v1alpha1.AWSSQSTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssqstargetsResource, c.ns, aWSSQSTarget), &v1alpha1.AWSSQSTarget{})
...
func (c *FakeAWSSQSTargets) Update(ctx context.Context, aWSSQSTarget *v1alpha1.AWSSQSTarget, opts v1.UpdateOptions) (result *v1alpha1.AWSSQSTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssqstargetsResource, c.ns, aWSSQSTarget), &v1alpha1.AWSSQSTarget{})
...
func (c *FakeAWSSQSTargets) UpdateStatus(ctx context.Context, aWSSQSTarget *v1alpha1.AWSSQSTarget, opts v1.UpdateOptions) (*v1alpha1.AWSSQSTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(awssqstargetsResource, "status", c.ns, aWSSQSTarget), &v1alpha1.AWSSQSTarget{})
...
func (c *FakeAWSSQSTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(awssqstargetsResource, c.ns, name, opts), &v1alpha1.AWSSQSTarget{})
...
func (c *FakeAWSSQSTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(awssqstargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AWSSQSTargetList{})
	return err
}
...
func (c *FakeAWSSQSTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AWSSQSTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssqstargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.AWSSQSTarget{})
