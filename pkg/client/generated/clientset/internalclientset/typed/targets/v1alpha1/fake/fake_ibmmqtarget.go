...
var ibmmqtargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "ibmmqtargets"}

var ibmmqtargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "IBMMQTarget"}
...
func (c *FakeIBMMQTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IBMMQTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ibmmqtargetsResource, c.ns, name), &v1alpha1.IBMMQTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IBMMQTarget), err
}
...
func (c *FakeIBMMQTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IBMMQTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ibmmqtargetsResource, ibmmqtargetsKind, c.ns, opts), &v1alpha1.IBMMQTargetList{})
	...
	list := &v1alpha1.IBMMQTargetList{ListMeta: obj.(*v1alpha1.IBMMQTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.IBMMQTargetList).Items {
...
func (c *FakeIBMMQTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(ibmmqtargetsResource, c.ns, opts))
...
func (c *FakeIBMMQTargets) Create(ctx context.Context, iBMMQTarget *v1alpha1.IBMMQTarget, opts v1.CreateOptions) (result *v1alpha1.IBMMQTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ibmmqtargetsResource, c.ns, iBMMQTarget), &v1alpha1.IBMMQTarget{})
...
func (c *FakeIBMMQTargets) Update(ctx context.Context, iBMMQTarget *v1alpha1.IBMMQTarget, opts v1.UpdateOptions) (result *v1alpha1.IBMMQTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ibmmqtargetsResource, c.ns, iBMMQTarget), &v1alpha1.IBMMQTarget{})
...
func (c *FakeIBMMQTargets) UpdateStatus(ctx context.Context, iBMMQTarget *v1alpha1.IBMMQTarget, opts v1.UpdateOptions) (*v1alpha1.IBMMQTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ibmmqtargetsResource, "status", c.ns, iBMMQTarget), &v1alpha1.IBMMQTarget{})
...
func (c *FakeIBMMQTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ibmmqtargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.IBMMQTargetList{})
	return err
}
...
func (c *FakeIBMMQTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IBMMQTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ibmmqtargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IBMMQTarget{})
