...
var splunktargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "splunktargets"}

var splunktargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "SplunkTarget"}
...
func (c *FakeSplunkTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(splunktargetsResource, c.ns, name), &v1alpha1.SplunkTarget{})
