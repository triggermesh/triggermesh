...
func (c *jiraTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JiraTarget, err error) {
	result = &v1alpha1.JiraTarget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *jiraTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JiraTargetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JiraTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jiratargets").
...
func (c *jiraTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *jiraTargets) Create(ctx context.Context, jiraTarget *v1alpha1.JiraTarget, opts v1.CreateOptions) (result *v1alpha1.JiraTarget, err error) {
	result = &v1alpha1.JiraTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("jiratargets").
...
func (c *jiraTargets) Update(ctx context.Context, jiraTarget *v1alpha1.JiraTarget, opts v1.UpdateOptions) (result *v1alpha1.JiraTarget, err error) {
	result = &v1alpha1.JiraTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jiratargets").
		Name(jiraTarget.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jiraTarget).
		Do(ctx).
		Into(result)
...
func (c *jiraTargets) UpdateStatus(ctx context.Context, jiraTarget *v1alpha1.JiraTarget, opts v1.UpdateOptions) (result *v1alpha1.JiraTarget, err error) {
	result = &v1alpha1.JiraTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jiratargets").
...
func (c *jiraTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *jiraTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *jiraTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JiraTarget, err error) {
	result = &v1alpha1.JiraTarget{}
