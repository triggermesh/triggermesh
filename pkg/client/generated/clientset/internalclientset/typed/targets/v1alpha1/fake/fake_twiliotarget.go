...
var twiliotargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "twiliotargets"}

var twiliotargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "TwilioTarget"}
...
func (c *FakeTwilioTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TwilioTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(twiliotargetsResource, c.ns, name), &v1alpha1.TwilioTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TwilioTarget), err
}
...
func (c *FakeTwilioTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TwilioTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(twiliotargetsResource, twiliotargetsKind, c.ns, opts), &v1alpha1.TwilioTargetList{})
	...
	list := &v1alpha1.TwilioTargetList{ListMeta: obj.(*v1alpha1.TwilioTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.TwilioTargetList).Items {
...
func (c *FakeTwilioTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(twiliotargetsResource, c.ns, opts))
...
func (c *FakeTwilioTargets) Create(ctx context.Context, twilioTarget *v1alpha1.TwilioTarget, opts v1.CreateOptions) (result *v1alpha1.TwilioTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(twiliotargetsResource, c.ns, twilioTarget), &v1alpha1.TwilioTarget{})
...
func (c *FakeTwilioTargets) Update(ctx context.Context, twilioTarget *v1alpha1.TwilioTarget, opts v1.UpdateOptions) (result *v1alpha1.TwilioTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(twiliotargetsResource, c.ns, twilioTarget), &v1alpha1.TwilioTarget{})
...
func (c *FakeTwilioTargets) UpdateStatus(ctx context.Context, twilioTarget *v1alpha1.TwilioTarget, opts v1.UpdateOptions) (*v1alpha1.TwilioTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(twiliotargetsResource, "status", c.ns, twilioTarget), &v1alpha1.TwilioTarget{})
...
func (c *FakeTwilioTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(twiliotargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TwilioTargetList{})
	return err
}
...
func (c *FakeTwilioTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TwilioTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(twiliotargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TwilioTarget{})
