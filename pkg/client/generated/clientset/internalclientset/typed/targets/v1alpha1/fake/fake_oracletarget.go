...
var oracletargetsResource = schema.GroupVersionResource{Group: "targets.triggermesh.io", Version: "v1alpha1", Resource: "oracletargets"}

var oracletargetsKind = schema.GroupVersionKind{Group: "targets.triggermesh.io", Version: "v1alpha1", Kind: "OracleTarget"}
...
func (c *FakeOracleTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OracleTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(oracletargetsResource, c.ns, name), &v1alpha1.OracleTarget{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.OracleTarget), err
}
...
func (c *FakeOracleTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OracleTargetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(oracletargetsResource, oracletargetsKind, c.ns, opts), &v1alpha1.OracleTargetList{})
	...
	list := &v1alpha1.OracleTargetList{ListMeta: obj.(*v1alpha1.OracleTargetList).ListMeta}
	for _, item := range obj.(*v1alpha1.OracleTargetList).Items {
...
func (c *FakeOracleTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(oracletargetsResource, c.ns, opts))
...
func (c *FakeOracleTargets) Create(ctx context.Context, oracleTarget *v1alpha1.OracleTarget, opts v1.CreateOptions) (result *v1alpha1.OracleTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(oracletargetsResource, c.ns, oracleTarget), &v1alpha1.OracleTarget{})
...
func (c *FakeOracleTargets) Update(ctx context.Context, oracleTarget *v1alpha1.OracleTarget, opts v1.UpdateOptions) (result *v1alpha1.OracleTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(oracletargetsResource, c.ns, oracleTarget), &v1alpha1.OracleTarget{})
...
func (c *FakeOracleTargets) UpdateStatus(ctx context.Context, oracleTarget *v1alpha1.OracleTarget, opts v1.UpdateOptions) (*v1alpha1.OracleTarget, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(oracletargetsResource, "status", c.ns, oracleTarget), &v1alpha1.OracleTarget{})
...
func (c *FakeOracleTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(oracletargetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.OracleTargetList{})
	return err
}
...
func (c *FakeOracleTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OracleTarget, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(oracletargetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.OracleTarget{})
