...
func (*GoogleCloudAuditLogsSource) GetGroupVersionKind() schema.GroupVersionKind {
	return SchemeGroupVersion.WithKind("GoogleCloudAuditLogsSource")
}

// GetConditionSet implements duckv1.KRShaped.
func (*GoogleCloudAuditLogsSource) GetConditionSet() apis.ConditionSet {
	return GoogleCloudAuditLogsSourceConditionSet
}
...
func (s *GoogleCloudAuditLogsSource) GetStatusManager() *EventSourceStatusManager {
...
func (*GoogleCloudAuditLogsSource) GetEventTypes() []string {
	return []string{
		GoogleCloudAuditLogsGenericEventType,
	}
}
...
func (s *GoogleCloudAuditLogsSourceStatus) MarkSubscribed() {
	GoogleCloudAuditLogsSourceConditionSet.Manage(s).MarkTrue(GoogleCloudAuditLogsConditionSubscribed)
}
