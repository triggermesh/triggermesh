...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GoogleCloudSourceAuth) DeepCopyInto(out *GoogleCloudSourceAuth) {
	*out = *in
	if in.ServiceAccountKey != nil {
		in, out := &in.ServiceAccountKey, &out.ServiceAccountKey
		*out = new(commonv1alpha1.ValueFromField)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GoogleCloudSourceAuth.
func (in *GoogleCloudSourceAuth) DeepCopy() *GoogleCloudSourceAuth {
	if in == nil {
		return nil
	}
	out := new(GoogleCloudSourceAuth)
