...
func TestStringerGCloudIoTResourceName(t *testing.T) {
	testCases := []struct {
		name         string
		input        GCloudIoTResourceName
		expectOutput string
	}{{
		...
		expectOutput: "projects/p/locations/l/c/r",
	}, {
...
func TestMarshalGCloudIoTResourceName(t *testing.T) {
	testCases := []struct {
		name              string
		input             GCloudIoTResourceName
		expectOutput      string
...
func TestUnmarshalGCloudIoTResourceName(t *testing.T) {
	testCases := []struct {
		name              string
		input             string
		expectOutput      GCloudIoTResourceName
		expectErrContains string
	}{{
		name:  "Valid resource name format",
		input: `"projects/p/locations/l/c/r"`,
		expectOutput: GCloudIoTResourceName{
			Project:    "p",
			Location:   "l",
			Collection: "c",
