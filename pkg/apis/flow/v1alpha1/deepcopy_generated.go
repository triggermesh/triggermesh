...
func (in *EventFlowStatus) DeepCopyInto(out *EventFlowStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventFlowStatus.
func (in *EventFlowStatus) DeepCopy() *EventFlowStatus {
	if in == nil {
		return nil
	}
	out := new(EventFlowStatus)
	in.DeepCopyInto(out)
	return out
}
