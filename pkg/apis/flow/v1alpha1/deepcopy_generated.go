...
func (in *DataWeaveTransformationSpec) DeepCopyInto(out *DataWeaveTransformationSpec) {
	*out = *in
	if in.DwSpell != nil {
		in, out := &in.DwSpell, &out.DwSpell
		*out = new(ValueFromField)
		(*in).DeepCopyInto(*out)
	}
	if in.AllowPerEventDwSpell != nil {
		in, out := &in.AllowPerEventDwSpell, &out.AllowPerEventDwSpell
		*out = new(bool)
		**out = **in
	}
	if in.InputContentType != nil {
		in, out := &in.InputContentType, &out.InputContentType
		*out = new(string)
		**out = **in
	}
	if in.OutputContentType != nil {
		in, out := &in.OutputContentType, &out.OutputContentType
		*out = new(string)
		**out = **in
	}
