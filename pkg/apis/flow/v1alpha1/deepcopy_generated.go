...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataWeaveTransformationStatus) DeepCopyInto(out *DataWeaveTransformationStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataWeaveTransformationStatus.
func (in *DataWeaveTransformationStatus) DeepCopy() *DataWeaveTransformationStatus {
	if in == nil {
		return nil
	}
	out := new(DataWeaveTransformationStatus)
	in.DeepCopyInto(out)
	return out
}
