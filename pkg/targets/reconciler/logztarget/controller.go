...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/logztarget"
...
func NewController(
	...
	r.base = common.NewGenericServiceReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.LogzTarget] {
			return informer.Lister().LogzTargets(namespace)
		},
	)
