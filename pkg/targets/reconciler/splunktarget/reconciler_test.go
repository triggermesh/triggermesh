...
func reconcilerCtor(cfg *adapterConfig) Ctor {
	return func(t *testing.T, ctx context.Context, _ *rt.TableRow, ls *Listers) controller.Reconciler {
		r := &Reconciler{
			...
			adapterCfg: cfg,
			trgLister:  ls.GetSplunkTargetLister().SplunkTargets,
		}
...
func newTarget() *v1alpha1.SplunkTarget {
	trg := &v1alpha1.SplunkTarget{
		Spec: v1alpha1.SplunkTargetSpec{
			Endpoint: apis.URL{Scheme: "https", Host: "mysplunk.example.com:8088"},
		},
	}
