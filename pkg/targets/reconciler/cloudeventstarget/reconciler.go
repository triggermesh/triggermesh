...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.CloudEventsTarget, listersv1alpha1.CloudEventsTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.CloudEventsTarget) reconciler.Event {
