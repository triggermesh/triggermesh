...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.UiPathTarget, listersv1alpha1.UiPathTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.UiPathTarget) reconciler.Event {
