...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awss3target"
...
func NewController(
	...
	r.base = common.NewGenericServiceReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.AWSS3Target] {
			return informer.Lister().AWSS3Targets(namespace)
		},
	)
