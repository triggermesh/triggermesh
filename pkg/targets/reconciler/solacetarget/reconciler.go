...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.SolaceTarget, listersv1alpha1.SolaceTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.SolaceTarget) reconciler.Event {
