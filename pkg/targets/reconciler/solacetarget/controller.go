...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/solacetarget"
...
func NewController(
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.SolaceTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().SolaceTargets,
	)
