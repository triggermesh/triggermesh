...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AzureServiceBusTarget, listersv1alpha1.AzureServiceBusTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AzureServiceBusTarget) reconciler.Event {
