...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azureservicebustarget"
...
func NewController(
	...
	typ := (*v1alpha1.AzureServiceBusTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.AzureServiceBusTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureServiceBusTargets,
	)
