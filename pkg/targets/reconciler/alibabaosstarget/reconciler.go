...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AlibabaOSSTarget, listersv1alpha1.AlibabaOSSTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AlibabaOSSTarget) reconciler.Event {
