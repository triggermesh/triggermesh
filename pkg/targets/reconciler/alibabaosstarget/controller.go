...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/alibabaosstarget"
...
func NewController(
	...
	typ := (*v1alpha1.AlibabaOSSTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.AlibabaOSSTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AlibabaOSSTargets,
	)
