...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azuresentineltarget"
...
func NewController(
	...
	typ := (*v1alpha1.AzureSentinelTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.AzureSentinelTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureSentinelTargets,
	)
