...
// reconcilerCtor returns a Ctor for a SendgridTarget Reconciler.
...
func newTarget() *v1alpha1.SendGridTarget {
	trg := &v1alpha1.SendGridTarget{
		Spec: v1alpha1.SendGridTargetSpec{},
	}
