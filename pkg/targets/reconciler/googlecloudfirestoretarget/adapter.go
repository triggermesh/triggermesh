...
const (
	adapterName            = "googlecloudfirestoretarget"
	evnDefaultCollection   = "GOOGLE_FIRESTORE_DEFAULT_COLLECTION"
...
func makeAppEnv(o *googlecloudfirestorev1alpha1.GoogleCloudFirestoreTarget) []corev1.EnvVar {
