...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/datadogtarget"
...
func NewController(
	...
	typ := (*v1alpha1.DatadogTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.DatadogTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().DatadogTargets,
	)
