...
import (
	...
	datadogv1alpha1 "github.com/triggermesh/triggermesh/pkg/apis/targets/v1alpha1"
)

const (
	adapterName = "datadogtarget"
...
func makeTargetAdapterKService(target *datadogv1alpha1.DatadogTarget, cfg *adapterConfig) *servingv1.Service {
...
func makeAppEnv(spec *v1alpha1.DatadogTargetSpec) []corev1.EnvVar {
	env := []corev1.EnvVar{
		{
			Name: envDatadogAPIKey,
			ValueFrom: &corev1.EnvVarSource{
				SecretKeyRef: spec.DatadogAPIKey.SecretKeyRef,
			},
		},
	}
