...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AWSSNSTarget, listersv1alpha1.AWSSNSTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AWSSNSTarget) reconciler.Event {
