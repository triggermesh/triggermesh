...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.SalesforceTarget, listersv1alpha1.SalesforceTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.SalesforceTarget) reconciler.Event {
