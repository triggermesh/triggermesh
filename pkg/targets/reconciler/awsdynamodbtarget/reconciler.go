...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AWSDynamoDBTarget, listersv1alpha1.AWSDynamoDBTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AWSDynamoDBTarget) reconciler.Event {
