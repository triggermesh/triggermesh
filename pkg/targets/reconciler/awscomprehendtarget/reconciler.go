...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AWSComprehendTarget, listersv1alpha1.AWSComprehendTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AWSComprehendTarget) reconciler.Event {
