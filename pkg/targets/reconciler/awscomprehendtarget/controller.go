...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awscomprehendtarget"
...
func NewController(
	...
	typ := (*v1alpha1.AWSComprehendTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.AWSComprehendTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AWSComprehendTargets,
	)
