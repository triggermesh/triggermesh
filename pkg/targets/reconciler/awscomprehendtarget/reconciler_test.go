...
// reconcilerCtor returns a Ctor for a AWSComprehendTarget Reconciler.
...
func newTarget() *v1alpha1.AWSComprehendTarget {
	trg := &v1alpha1.AWSComprehendTarget{
		Spec: v1alpha1.AWSComprehendTargetSpec{
			Region:   "us-fake-0",
			Language: "en",
		},
	}
