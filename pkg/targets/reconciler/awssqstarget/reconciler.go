...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AWSSQSTarget, listersv1alpha1.AWSSQSTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AWSSQSTarget) reconciler.Event {
