...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/azureeventhubstarget"
...
func NewController(
	...
	typ := (*v1alpha1.AzureEventHubsTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.AzureEventHubsTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().AzureEventHubsTargets,
	)
