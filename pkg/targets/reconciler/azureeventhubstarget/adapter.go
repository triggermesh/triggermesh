...
const (
	...
	envConnectionString    = "AZURE_EVENTHUBS_CONNECTION_STRING"
...
type adapterConfig struct {
	...
	// Container image
	Image string `envconfig:"AZUREEVENTHUBS_ADAPTER_IMAGE" default:"gcr.io/triggermesh-private/azureeventhubstarget-adapter"`
}
	...
	env := []corev1.EnvVar{
		{
			...
			Value: o.Spec.DiscardCEContext,
		}, {
			Name:  envConnectionString,
			Value: o.Spec.ConnectionString.SecretKeyRef,
		}, {
