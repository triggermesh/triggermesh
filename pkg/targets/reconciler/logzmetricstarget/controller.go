...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/logzmetricstarget"
...
func NewController(
	...
	typ := (*v1alpha1.LogzMetricsTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler[*v1alpha1.LogzMetricsTarget](
		ctx,
		typ.GetGroupVersionKind(),
		impl.Tracker,
		impl.EnqueueControllerOf,
		informer.Lister().LogzMetricsTargets,
	)
