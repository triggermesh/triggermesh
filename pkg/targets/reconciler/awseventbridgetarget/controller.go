...
import (
	...
	awseventbridgetargetinformer "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/awseventbridgetarget"
	"github.com/triggermesh/triggermesh/pkg/client/generated/injection/reconciler/targets/v1alpha1/awseventbridgetarget"
...
func NewController(
	...
	impl := awseventbridgetarget.NewImpl(ctx, &eventBridgeReconciler{
	...
	awsTargetInformer := awseventbridgetargetinformer.Get(ctx)
	awsTargetInformer.Informer().AddEventHandler(controller.HandleAll(impl.Enqueue))

	serviceInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.FilterControllerGK(v1alpha1.Kind("AWSEventBridgeTarget")),
