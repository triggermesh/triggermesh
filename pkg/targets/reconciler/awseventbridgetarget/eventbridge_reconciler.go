...
import (
	...
	reconcilers "github.com/triggermesh/triggermesh/pkg/client/generated/injection/reconciler/targets/v1alpha1/awseventbridgetarget"
	libreconciler "github.com/triggermesh/triggermesh/pkg/targets/reconciler"
)

// Reconciler reconciles the target adapter object
type eventBridgeReconciler struct {
...
var _ reconcilers.Interface = (*eventBridgeReconciler)(nil)
...
func (r *eventBridgeReconciler) ReconcileKind(ctx context.Context, trg *awsv1alpha1.AWSEventBridgeTarget) pkgreconciler.Event {
	...
	adapter, event := r.ksvcr.ReconcileKService(ctx, trg, makeTargetEventBridgeAdapterKService(trg, r.adapterCfg))
