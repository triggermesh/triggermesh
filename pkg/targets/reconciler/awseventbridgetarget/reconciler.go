...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.AWSEventBridgeTarget, listersv1alpha1.AWSEventBridgeTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.AWSEventBridgeTarget) reconciler.Event {
