...
type Reconciler struct {
	base       common.GenericAdapterReconciler[*v1alpha1.JiraTarget, *servingv1.Service]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.JiraTarget) reconciler.Event {
