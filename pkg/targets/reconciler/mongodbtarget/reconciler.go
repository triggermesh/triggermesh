...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.MongoDBTarget, listersv1alpha1.MongoDBTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.MongoDBTarget) reconciler.Event {
