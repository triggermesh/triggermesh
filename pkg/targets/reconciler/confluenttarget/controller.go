...
import (
	...
	informerv1alpha1 "github.com/triggermesh/triggermesh/pkg/client/generated/injection/informers/targets/v1alpha1/confluenttarget"
...
func NewController(
	...
	typ := (*v1alpha1.ConfluentTarget)(nil)
	...
	r.base = common.NewGenericServiceReconciler(
		...
		func(namespace string) common.Lister[*v1alpha1.ConfluentTarget] {
			return informer.Lister().ConfluentTargets(namespace)
		},
	)
